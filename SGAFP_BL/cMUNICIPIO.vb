...
#End Region
    ...
    Public Function ObtenerLista(ByVal CODIGO_DEPARTAMENTO As String, ByVal Optional recuperarHijas As Boolean = False, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaMUNICIPIO
        Try
            Dim mListaMUNICIPIO As New ListaMUNICIPIO
            mListaMUNICIPIO = mDb.ObtenerListaPorID(CODIGO_DEPARTAMENTO, asColumnaOrden, asTipoOrden)
    ...
    Public Function ObtenerMUNICIPIO(ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal Optional recuperarHijas As Boolean = False, ByVal Optional recuperarForaneas As Boolean = False) As MUNICIPIO
        Try
    ...
    Public Function EliminarMUNICIPIO(ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String) As Integer
        Try
    ...
    Public Function AgregarMUNICIPIO(ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal NOMBRE As String, ByVal USERID As String, ByVal LASTUPDATE As DateTime, ByVal LATITUD As Decimal, ByVal LONGITUD As Decimal) As Integer
        Try
            Dim lEntidad As New MUNICIPIO
            lEntidad.CODIGO_DEPARTAMENTO = CODIGO_DEPARTAMENTO
            lEntidad.CODIGO_MUNICIPIO = CODIGO_MUNICIPIO
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, False)> _
    Public Function ActualizarMUNICIPIO(ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal NOMBRE As String, ByVal USERID As String, ByVal LASTUPDATE As DateTime, ByVal LATITUD As Decimal, ByVal LONGITUD As Decimal) As Integer
        Try
            Dim lEntidad As New MUNICIPIO
            lEntidad.CODIGO_DEPARTAMENTO = CODIGO_DEPARTAMENTO
            lEntidad.CODIGO_MUNICIPIO = CODIGO_MUNICIPIO
    ...
    Public Function ObtenerDataSetPorId(ByVal CODIGO_DEPARTAMENTO As String, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As DataSet
        Try
            Return mDb.ObtenerDataSetPorID(CODIGO_DEPARTAMENTO, asColumnaOrden, asTipoOrden)
        Catch ex as Exception
            ExceptionManager.Publish(ex)
            Return Nothing
        End Try
    ...
    Public Function ObtenerDataSetPorId(ByVal CODIGO_DEPARTAMENTO As String, ByRef ds As DataSet, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As Integer
        Try
            Return mDb.ObtenerDataSetPorID(CODIGO_DEPARTAMENTO, ds, asColumnaOrden, asTipoOrden)
        Catch ex as Exception
            ExceptionManager.Publish(ex)
            Return -1
        End Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorDEPARTAMENTO(ByVal CODIGO_DEPARTAMENTO As String, ByVal Optional recuperarHijas As Boolean = False, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaMUNICIPIO
        Try
            Dim mListaMUNICIPIO As New ListaMUNICIPIO
            mListaMUNICIPIO = mDb.ObtenerListaPorDEPARTAMENTO(CODIGO_DEPARTAMENTO, asColumnaOrden, asTipoOrden)
            If Not mListaMUNICIPIO Is Nothing And recuperarForaneas Then
                For Each lEntidad As MUNICIPIO in  mListaMUNICIPIO
                    Try
                        Me.RecuperarForaneas(lEntidad)
