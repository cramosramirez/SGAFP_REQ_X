''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_BL
''' Class	 : BL.cSOLIC_INSCRIPCION_AF_HIST
'''
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Lógica de Negocios que utiliza la capa de Acceso a Datos y provee
''' las funciones CRUD(Create, Read, Update y Delete) de la tabla SOLIC_INSCRIPCION_AF_HIST
''' </summary>
''' <remarks>
...
Public Class cSOLIC_INSCRIPCION_AF_HIST
    Inherits controladorBase

#Region " Metodos Generador "

#Region " Privadas "
    Private mDb as New dbSOLIC_INSCRIPCION_AF_HIST()
    Private mEntidad as New SOLIC_INSCRIPCION_AF_HIST
#End Region
    ...
    Public Function ObtenerLista(ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorID(asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                ...
                Next
            End If
            Return mListaSOLIC_INSCRIPCION_AF_HIST
        Catch ex as Exception
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerSOLIC_INSCRIPCION_AF_HIST(ByRef aEntidad As SOLIC_INSCRIPCION_AF_HIST, ByVal Optional recuperarForaneas As Boolean = False) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que selecciona un Registro y lo Devuelve en una Entidad de la Tabla SOLIC_INSCRIPCION_AF_HIST.
    ''' </summary>
    ...
    Public Function ObtenerSOLIC_INSCRIPCION_AF_HIST(ByVal ID_SOLICITUD_HIST As Decimal, ByVal Optional recuperarForaneas As Boolean = False) As SOLIC_INSCRIPCION_AF_HIST
        Try
    ...
    Public Function EliminarSOLIC_INSCRIPCION_AF_HIST(ByVal ID_SOLICITUD_HIST As Decimal) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, False)> _
    Public Function EliminarSOLIC_INSCRIPCION_AF_HIST(ByVal aEntidad As SOLIC_INSCRIPCION_AF_HIST, ByVal aTipoConcurrencia As TipoConcurrencia) As Integer
        Try
    ...
    Public Function AgregarSOLIC_INSCRIPCION_AF_HIST(ByVal ID_SOLICITUD_HIST As Decimal, ByVal ID_SOLICITUD As Decimal, ByVal FECHA_PRESENTACION As DateTime, ByVal ID_PARTICIPANTE As Decimal, ByVal ID_ACCION_FORMATIVA As Decimal, ByVal ID_ESTADO_SOLICITUD As Decimal, ByVal NOMBRES As String, ByVal APELLIDOS As String, ByVal DUI As String, ByVal TIPO_DOCTO As Decimal, ByVal NUM_DOCTO As String, ByVal NIT As String, ByVal ISSS As String, ByVal ID_TIPO_SOLICITUD As Decimal, ByVal ID_PAIS As Decimal, ByVal DEPARTAMENTO_NAC As String, ByVal MUNICIPIO_NAC As String, ByVal FECHA_NACIMIENTO As DateTime, ByVal GENERO As String, ByVal EDAD As Decimal, ByVal MIEMBROS_GRUPO_FAMILIAR As Decimal, ByVal ID_ESTADO_CIVIL As Decimal, ByVal ES_JEFE_HOGAR As Decimal, ByVal TIENE_HIJOS As Decimal, ByVal NO_DE_HIJOS As Decimal, ByVal SE_DEDICA_ALGUNA_PROFESION As Decimal, ByVal PROFESION_OFICIO As String, ByVal DIRECCION As String, ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal TELEFONO As String, ByVal MOVIL As String, ByVal EMAIL As String, ByVal CON_DISCAPACIDAD As Decimal, ByVal DISC_OTRA As String, ByVal ID_LEE_ESCRIBE As Decimal, ByVal ID_NIVEL_ACADEMICO As Decimal, ByVal OTRA_EDUCACION_FORMAL As String, ByVal TITULO_CERTIFICADO_OBTENIDO As String, ByVal ESTUDIA_ACTUALMENTE As Decimal, ByVal ID_TIEMPO_DEJO_ESTUDIAR As Decimal, ByVal RECIBIO_CURSO_ANTERIOR As String, ByVal BENEF_PROM_EMP_ACT As Decimal, ByVal BENEF_OBT_EMPLEO As Decimal, ByVal BENEF_OBT_ING_EXTRA As Decimal, ByVal BENEF_CAMB_EMP_X_CURSO As Decimal, ByVal BENEF_TRAB_CTA_PROPIA As Decimal, ByVal BENEF_OTRO As String, ByVal RAZON_NO_BENEFICIO As String, ByVal OCUACT_TRABAJA As Decimal, ByVal OCUACT_ESTUDIA As Decimal, ByVal OCUACT_DESOCUPADO As Decimal, ByVal OCUACT_OFICIO_HOGAR As Decimal, ByVal OCUACT_BUSCA_TRABAJO As Decimal, ByVal OCUACT_OTRA As String, ByVal ID_TIPO_EMPLEO As Decimal, ByVal SECTOR_EMPLEO As Decimal, ByVal TRABAJO_ANTERIOR As String, ByVal RECIBE_INGRESOS As Decimal, ByVal MANERA_OBT_ING_TRABAJO As Decimal, ByVal MANERA_OBT_ING_AYUDA_FAM As Decimal, ByVal MANERA_OBT_ING_REMESA As Decimal, ByVal MANERA_OBT_ING_PENSION As Decimal, ByVal MANERA_OBT_ING_OTRO As String, ByVal EXPFOR_PROMOCION_EMPLEO As Decimal, ByVal EXPFOR_CAMBIAR_EMPLEO As Decimal, ByVal EXPFOR_OBTENER_EMPLEO As Decimal, ByVal EXPFOR_TRABAJAR_CTA_PROPIA As Decimal, ByVal EXPFOR_INGRESOS_EXTRAS As Decimal, ByVal EXPFOR_NINGUNO As Decimal, ByVal EXPFOR_OTRO As String, ByVal CURSO_REL_TRAB_ACTUAL As Decimal, ByVal CURSO_REL_TRAB_NUEVO As Decimal, ByVal NOMBRE_REFERENCIA As String, ByVal ID_REFERENCIA As Decimal, ByVal DIRECCION_REFERENCIA As String, ByVal DEPARTAMENTO_REFERENCIA As String, ByVal MUNICIPIO_REFERENCIA As String, ByVal TELEFONO_REFERENCIA As String, ByVal MOVIL_REFERENCIA As String, ByVal EMAIL_REFERENCIA As String, ByVal SUGERENCIAS As String, ByVal USERID As String, ByVal LASTUPDATE As DateTime) As Integer
        Try
            ...
            Return Me.ActualizarSOLIC_INSCRIPCION_AF_HIST(lEntidad)
        Catch ex as Exception
            ExceptionManager.Publish(ex)
            Return -1
        End Try
    ...
    Public Function ActualizarSOLIC_INSCRIPCION_AF_HIST(ByVal aEntidad As SOLIC_INSCRIPCION_AF_HIST) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, False)> _
    Public Function ActualizarSOLIC_INSCRIPCION_AF_HIST(ByVal aEntidad As SOLIC_INSCRIPCION_AF_HIST, ByVal aTipoConcurrencia As TipoConcurrencia) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, False)> _
    Public Function ActualizarSOLIC_INSCRIPCION_AF_HIST(ByVal ID_SOLICITUD_HIST As Decimal, ByVal ID_SOLICITUD As Decimal, ByVal FECHA_PRESENTACION As DateTime, ByVal ID_PARTICIPANTE As Decimal, ByVal ID_ACCION_FORMATIVA As Decimal, ByVal ID_ESTADO_SOLICITUD As Decimal, ByVal NOMBRES As String, ByVal APELLIDOS As String, ByVal DUI As String, ByVal TIPO_DOCTO As Decimal, ByVal NUM_DOCTO As String, ByVal NIT As String, ByVal ISSS As String, ByVal ID_TIPO_SOLICITUD As Decimal, ByVal ID_PAIS As Decimal, ByVal DEPARTAMENTO_NAC As String, ByVal MUNICIPIO_NAC As String, ByVal FECHA_NACIMIENTO As DateTime, ByVal GENERO As String, ByVal EDAD As Decimal, ByVal MIEMBROS_GRUPO_FAMILIAR As Decimal, ByVal ID_ESTADO_CIVIL As Decimal, ByVal ES_JEFE_HOGAR As Decimal, ByVal TIENE_HIJOS As Decimal, ByVal NO_DE_HIJOS As Decimal, ByVal SE_DEDICA_ALGUNA_PROFESION As Decimal, ByVal PROFESION_OFICIO As String, ByVal DIRECCION As String, ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal TELEFONO As String, ByVal MOVIL As String, ByVal EMAIL As String, ByVal CON_DISCAPACIDAD As Decimal, ByVal DISC_OTRA As String, ByVal ID_LEE_ESCRIBE As Decimal, ByVal ID_NIVEL_ACADEMICO As Decimal, ByVal OTRA_EDUCACION_FORMAL As String, ByVal TITULO_CERTIFICADO_OBTENIDO As String, ByVal ESTUDIA_ACTUALMENTE As Decimal, ByVal ID_TIEMPO_DEJO_ESTUDIAR As Decimal, ByVal RECIBIO_CURSO_ANTERIOR As String, ByVal BENEF_PROM_EMP_ACT As Decimal, ByVal BENEF_OBT_EMPLEO As Decimal, ByVal BENEF_OBT_ING_EXTRA As Decimal, ByVal BENEF_CAMB_EMP_X_CURSO As Decimal, ByVal BENEF_TRAB_CTA_PROPIA As Decimal, ByVal BENEF_OTRO As String, ByVal RAZON_NO_BENEFICIO As String, ByVal OCUACT_TRABAJA As Decimal, ByVal OCUACT_ESTUDIA As Decimal, ByVal OCUACT_DESOCUPADO As Decimal, ByVal OCUACT_OFICIO_HOGAR As Decimal, ByVal OCUACT_BUSCA_TRABAJO As Decimal, ByVal OCUACT_OTRA As String, ByVal ID_TIPO_EMPLEO As Decimal, ByVal SECTOR_EMPLEO As Decimal, ByVal TRABAJO_ANTERIOR As String, ByVal RECIBE_INGRESOS As Decimal, ByVal MANERA_OBT_ING_TRABAJO As Decimal, ByVal MANERA_OBT_ING_AYUDA_FAM As Decimal, ByVal MANERA_OBT_ING_REMESA As Decimal, ByVal MANERA_OBT_ING_PENSION As Decimal, ByVal MANERA_OBT_ING_OTRO As String, ByVal EXPFOR_PROMOCION_EMPLEO As Decimal, ByVal EXPFOR_CAMBIAR_EMPLEO As Decimal, ByVal EXPFOR_OBTENER_EMPLEO As Decimal, ByVal EXPFOR_TRABAJAR_CTA_PROPIA As Decimal, ByVal EXPFOR_INGRESOS_EXTRAS As Decimal, ByVal EXPFOR_NINGUNO As Decimal, ByVal EXPFOR_OTRO As String, ByVal CURSO_REL_TRAB_ACTUAL As Decimal, ByVal CURSO_REL_TRAB_NUEVO As Decimal, ByVal NOMBRE_REFERENCIA As String, ByVal ID_REFERENCIA As Decimal, ByVal DIRECCION_REFERENCIA As String, ByVal DEPARTAMENTO_REFERENCIA As String, ByVal MUNICIPIO_REFERENCIA As String, ByVal TELEFONO_REFERENCIA As String, ByVal MOVIL_REFERENCIA As String, ByVal EMAIL_REFERENCIA As String, ByVal SUGERENCIAS As String, ByVal USERID As String, ByVal LASTUPDATE As DateTime) As Integer
        Try
            Dim lEntidad As New SOLIC_INSCRIPCION_AF_HIST
            lEntidad.ID_SOLICITUD_HIST = ID_SOLICITUD_HIST
            lEntidad.ID_SOLICITUD = ID_SOLICITUD
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorSOLICITUD_INSCRIPCION_AF(ByVal ID_SOLICITUD As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorSOLICITUD_INSCRIPCION_AF(ID_SOLICITUD, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorPARTICIPANTE(ByVal ID_PARTICIPANTE As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorPARTICIPANTE(ID_PARTICIPANTE, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorACCION_FORMATIVA(ByVal ID_ACCION_FORMATIVA As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorACCION_FORMATIVA(ID_ACCION_FORMATIVA, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorESTADO_SOLICITUD(ByVal ID_ESTADO_SOLICITUD As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorESTADO_SOLICITUD(ID_ESTADO_SOLICITUD, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorTIPO_SOLICITUD(ByVal ID_TIPO_SOLICITUD As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorTIPO_SOLICITUD(ID_TIPO_SOLICITUD, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorPAIS(ByVal ID_PAIS As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorPAIS(ID_PAIS, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorESTADO_CIVIL(ByVal ID_ESTADO_CIVIL As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorESTADO_CIVIL(ID_ESTADO_CIVIL, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorDEPARTAMENTO(ByVal CODIGO_DEPARTAMENTO As String, Optional ByVal recuperarForaneas As Boolean = False, Optional ByVal asColumnaOrden As String = "", Optional ByVal asTipoOrden As String = "ASC") As listaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New listaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorDEPARTAMENTO(CODIGO_DEPARTAMENTO, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST In mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorMUNICIPIO(ByVal CODIGO_DEPARTAMENTO As String, ByVal CODIGO_MUNICIPIO As String, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorMUNICIPIO(CODIGO_DEPARTAMENTO, CODIGO_MUNICIPIO, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorEDUC_LEE_ESCRIBE(ByVal ID_LEE_ESCRIBE As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorEDUC_LEE_ESCRIBE(ID_LEE_ESCRIBE, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorNIVEL_ACADEMICO(ByVal ID_NIVEL_ACADEMICO As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorNIVEL_ACADEMICO(ID_NIVEL_ACADEMICO, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorTIEMPO_DEJO_ESTUDIAR(ByVal ID_TIEMPO_DEJO_ESTUDIAR As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorTIEMPO_DEJO_ESTUDIAR(ID_TIEMPO_DEJO_ESTUDIAR, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorTIPO_EMPLEO(ByVal ID_TIPO_EMPLEO As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorTIPO_EMPLEO(ID_TIPO_EMPLEO, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorREFERENCIA(ByVal ID_REFERENCIA As Decimal, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaSOLIC_INSCRIPCION_AF_HIST
        Try
            Dim mListaSOLIC_INSCRIPCION_AF_HIST As New ListaSOLIC_INSCRIPCION_AF_HIST
            mListaSOLIC_INSCRIPCION_AF_HIST = mDb.ObtenerListaPorREFERENCIA(ID_REFERENCIA, asColumnaOrden, asTipoOrden)
            If Not mListaSOLIC_INSCRIPCION_AF_HIST Is Nothing And recuperarForaneas Then
                For Each lEntidad As SOLIC_INSCRIPCION_AF_HIST in  mListaSOLIC_INSCRIPCION_AF_HIST
                    Try
                        Me.RecuperarForaneas(lEntidad)
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Private Sub RecuperarForaneas(ByRef aEntidad As SOLIC_INSCRIPCION_AF_HIST )
        ...
        aEntidad.fkID_TIPO_EMPLEO = (New cTIPO_EMPLEO).ObtenerTIPO_EMPLEO(aEntidad.ID_TIPO_EMPLEO)
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Private Sub RecuperarHijas(ByRef aEntidad As SOLIC_INSCRIPCION_AF_HIST )
    End Sub
