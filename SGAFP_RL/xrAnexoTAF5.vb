...
#Region " Codigo Generado "
    ...
    Private Sub InitializeComponent()
        ...
        'XrTableRow5
        '
        Me.XrTableRow5.Cells.AddRange(New DevExpress.XtraReports.UI.XRTableCell() {Me.xrItem, Me.XrTableCell10, Me.XrTableCell11, Me.XrTableCell14, Me.XrTableCell15, Me.XrTableCell16, Me.XrTableCell17, Me.XrTableCell12})
        ...
        Me.XrTableCell10.Weight = 0.78579164560444892R
        '
        'XrTableCell11
        '
        ...
        Me.XrTableCell11.Weight = 0.69450789727879614R
        '
        'XrTableCell14
        '
    ...
    "OS"
        ...
        Me.XrTable10.LocationFloat = New DevExpress.Utils.PointFloat(302.2083!, 102.2916!)
        Me.XrTable10.Name = "XrTable10"
        Me.XrTable10.Rows.AddRange(New DevExpress.XtraReports.UI.XRTableRow() {Me.XrTableRow1})
        Me.XrTable10.SizeF = New System.Drawing.SizeF(363.4166!, 17.0833!)
        ...
        Me.XrTableCell7.Weight = 0.842054794312111R
        '
        'XrTableCell9
        '
        ...
        Me.XrTableCell9.Weight = 1.0566675878775209R
        '
        'XrTableCell8
        '
        ...
        Me.XrTable2.SizeF = New System.Drawing.SizeF(302.2082!, 51.87492!)
        ...
        Me.XrTableCell4.Weight = 2.357373853370599R
        '
        'XrTable1
        '
        ...
        Me.XrTable1.LocationFloat = New DevExpress.Utils.PointFloat(302.2083!, 119.3749!)
        Me.XrTable1.Name = "XrTable1"
        Me.XrTable1.Rows.AddRange(New DevExpress.XtraReports.UI.XRTableRow() {Me.XrTableRow2})
        Me.XrTable1.SizeF = New System.Drawing.SizeF(363.4166!, 34.79163!)
        ...
        Me.xrPageInfo1.LocationFloat = New DevExpress.Utils.PointFloat(0.0!, 237.6251!)
...
#End Region
    ...
    Private mTotalPaginaAnt As Decimal
    Private mSubTotal As Decimal
    Private mTotalAcum As Decimal
    Private municipioAnteriorTotal As String
    ...
    Private Sub xrTotalPaginaAnt_SummaryGetResult(sender As Object, e As DevExpress.XtraReports.UI.SummaryGetResultEventArgs) Handles xrTotalPaginaAnt.SummaryGetResult
        If mTotalPaginaAnt - mSubTotal < 0 Then
            e.Result = 0
        Else
            e.Result = mTotalPaginaAnt - mSubTotal
        End If
        e.Handled = True
    End Sub
    Private Sub xrTotalPaginaAnt_SummaryReset(sender As Object, e As System.EventArgs) Handles xrTotalPaginaAnt.SummaryReset
    End Sub
    Private Sub xrTotalPaginaAnt_SummaryRowChanged(sender As Object, e As System.EventArgs) Handles xrTotalPaginaAnt.SummaryRowChanged
        If municipioAnteriorTotal <> "" AndAlso municipioAnteriorTotal <> GetCurrentColumnValue("NOMBRE_DEPARTAMENTO") + GetCurrentColumnValue("NOMBRE_MUNICIPIO") Then
            mTotalPaginaAnt = 0
        Else
            mTotalPaginaAnt += Convert.ToDecimal(GetCurrentColumnValue("TOTAL"))
        End If
        municipioAnteriorTotal = GetCurrentColumnValue("NOMBRE_DEPARTAMENTO") + GetCurrentColumnValue("NOMBRE_MUNICIPIO")
    End Sub


    Private Sub xrSubTotal_SummaryGetResult(sender As Object, e As DevExpress.XtraReports.UI.SummaryGetResultEventArgs) Handles xrSubTotal.SummaryGetResult
        e.Result = mSubTotal
        '    e.Result = 0
        'If mTotalPaginaAnt - mSubTotal < 0 Then
        '    e.Result = 0
        ...
        e.Handled = True
    End Sub
    Private Sub xrSubTotal_SummaryReset(sender As Object, e As System.EventArgs) Handles xrSubTotal.SummaryReset
        mSubTotal = 0
    End Sub
    Private Sub xrSubTotal_SummaryRowChanged(sender As Object, e As System.EventArgs) Handles xrSubTotal.SummaryRowChanged
        mSubTotal += Convert.ToDecimal(GetCurrentColumnValue("TOTAL"))
    End Sub
End Class