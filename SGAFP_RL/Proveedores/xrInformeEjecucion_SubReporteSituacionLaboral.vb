Public Class xrInformeEjecucion_SubReporteSituacionLaboral
...
#Region "Codigo Generado"
    ...
    Friend WithEvents ParticipacionPorSituacionLaboralTableAdapter1 As SGAFP.DL.DS_DLTableAdapters.ParticipacionPorSituacionLaboralTableAdapter
    ...
    Private Sub InitializeComponent()
        ...
        Me.ParticipacionPorSituacionLaboralTableAdapter1 = New SGAFP.DL.DS_DLTableAdapters.ParticipacionPorSituacionLaboralTableAdapter
        ...
        Me.XrChart1.DataAdapter = Me.ParticipacionPorSituacionLaboralTableAdapter1
        Me.XrChart1.DataMember = "ParticipacionPorSituacionLaboral"
        ...
        Me.XrChart1.SeriesTemplate.ArgumentDataMember = "SITUACION_LABORAL"
        ...
        Pie3DSeriesView1.SizeAsPercentage = 90
        Me.XrChart1.SeriesTemplate.View = Pie3DSeriesView1
        Me.XrChart1.SizeF = New System.Drawing.SizeF(769.0!, 600.9999!)
        '
        'ParticipacionPorSituacionLaboralTableAdapter1
        '
        Me.ParticipacionPorSituacionLaboralTableAdapter1.ClearBeforeFill = True
        '
        'DS_DL1
        '
        ...
        '
        'xrInformeEjecucion_SubReporteSituacionLaboral
        '
        Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.TopMargin, Me.BottomMargin, Me.ReportHeader})
        Me.DataAdapter = Me.ParticipacionPorSituacionLaboralTableAdapter1
        Me.DataMember = "ParticipacionPorSituacionLaboral"
        Me.DataSource = Me.DS_DL1
        Me.Margins = New System.Drawing.Printing.Margins(29, 52, 3, 5)
        Me.Version = "10.1"
...
#End Region
    ...
    Public Sub CargarSituacionLaboralPorEjercicio(ByVal ID_EJERCICIO As String)
        Me.ParticipacionPorSituacionLaboralTableAdapter1.FillByEjercicio(Me.DS_DL1.ParticipacionPorSituacionLaboral, ID_EJERCICIO)
        SetearTotalParticipantes()
    End Sub

    Public Sub CargarSituacionLaboralPorEjercicioProveedor(ByVal ID_EJERCICIO As String, ByVal ID_PROVEEDOR_AF As Decimal)
        Me.ParticipacionPorSituacionLaboralTableAdapter1.FillByEjercicioProveedor(Me.DS_DL1.ParticipacionPorSituacionLaboral, ID_PROVEEDOR_AF, ID_EJERCICIO)
        SetearTotalParticipantes()
    End Sub

    Public Sub CargarSituacionLaboralPorEjercicioSitioCapacitacion(ByVal ID_EJERCICIO As String, ByVal ID_SITIO_CAPACITACION As Decimal)
        Me.ParticipacionPorSituacionLaboralTableAdapter1.FillByEjercicioSitioCapacitacion(Me.DS_DL1.ParticipacionPorSituacionLaboral, ID_SITIO_CAPACITACION, ID_EJERCICIO)
        SetearTotalParticipantes()
    End Sub
    ...
    Private Sub SetearTotalParticipantes()
        ...
        Resultado = Me.DS_DL1.ParticipacionPorSituacionLaboral.Compute("SUM(PARTICIPANTES)", "EJERCICIO<>''")
