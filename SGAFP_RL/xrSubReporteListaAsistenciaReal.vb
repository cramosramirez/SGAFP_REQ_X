...
#End Region
    ...
    Public Sub CargarDatos(ByVal ID_ACCION_FORMATIVA As Decimal, ByVal fechaInicio As DateTime, ByVal fechaFin As DateTime)
        ...
        Me.dS_DL1.Clear()
        Me.listadoAsistenciaTableAdapter1.FillPorAccionPeriodoReal(Me.dS_DL1.ListadoAsistencia, _ID_ACCION_FORMATIVA, _fechaInicial, _fechaFinal)
