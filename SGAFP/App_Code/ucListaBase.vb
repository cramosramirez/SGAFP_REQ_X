...
Public Class ucListaBase
    ...
    Public Sub AgregarButtonField(ByVal CommandName As String, ByVal Text As String, ByVal ButtonType As ButtonType, ByVal CausesValidation As Boolean, ByVal HeaderText As String)
        If gvListaBase Is Nothing Then Return

        Dim comando As New ButtonField
        comando.CausesValidation = CausesValidation
        comando.HeaderText = HeaderText
        comando.ButtonType = ButtonType
        comando.CommandName = CommandName
        comando.Text = Text
        comando.Visible = True
        comando.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        gvListaBase.Columns.Add(comando)
    ...
    Protected Sub gvListaBase_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gvListaBase.PageIndexChanging
        'If Me.ViewState("PorLista") Then
        '    Me.CargarDatosPorLista(Me.ViewState("lista"))
        'End If
