<%@ Page Title="" Language="VB" MasterPageFile="~/principalVacio.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Mapas_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:ASPxSiteMapDataSource ID="ASPxSiteMapDataSource1" runat="server" 
        ...
        StartingNodeUrl="~/Mapas/Default.aspx" 
