...
<table id="VistaDetalle" cellspacing="1px" cellpadding="0" border="0"  class="insatbl">
    ...
    <tr runat="server" id="trMODALIDAD_DE_FORMACION">
        ...
        <td align="left">
            <asp:Label CssClass="req" ID="Label7" Text="MODALIDAD DE FORMACIÓN *" runat="server" />
        </td>
        <td>
    ...
    <tr runat="server" id="trLUGAR_EJECUCION">
		<td width="3"></td>
		<td align="left" class="req" >
			<asp:Label runat="server" ID="Label1" Text="LUGAR EJECUCIÓN: *" /> </td>
		<td>
			<asp:TextBox CssClass="NormalUPPER" id="txtLUGAR_EJECUCION" runat="server" 
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                ...
                ErrorMessage="Escriba el lugar de ejecución del curso">*</asp:RequiredFieldValidator>           
        </td>
		<td width="3"></td>
	</tr>
