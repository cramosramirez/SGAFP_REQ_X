<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReporteResumenEjecucionHTP.ascx.vb" Inherits="controles_ucReporteResumenEjecucionHTP" %>
...
<script language="javascript" type="text/javascript">    
    ...
    function VerReporte() {              
        ...
        cReporte.PerformCallback(EJERCICIO);
        LoadingPanel.Show();
    }
</script>
     ...
     <PanelCollection>        
            <dx:PanelContent ID="PanelContent1" runat="server">   
                ...
                <uc1:ucCriteriosConsultaEjecucion ID="ucCriteriosConsultaEjecucion1" runat="server"  
                     VerPrograma="false" VerBotonMostrar="false" VerProveedor="false" VerCentroFormacion="false" VerAreaFormacion="false" VerClasificacionCursos="false" VerCodigoGrupo="false"  />     
