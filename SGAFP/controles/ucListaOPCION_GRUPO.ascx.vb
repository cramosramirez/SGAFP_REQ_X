...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaOPCION_GRUPO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla OPCION_GRUPO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderID_OPCION_GRUPO() As String
        Get
    ...
    Public Property HeaderID_OPCION_MENU() As String
        Get
    ...
    Public Property HeaderID_GRUPO_USUARIO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lOPCION_GRUPO As listaOPCION_GRUPO
        lOPCION_GRUPO = Me.mComponente.ObtenerLista()
        If lOPCION_GRUPO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lOPCION_GRUPO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Public Function CargarDatosPorOPCION_MENU(ByVal ID_OPCION_MENU As Decimal) As Integer
        Dim lOPCION_GRUPO As listaOPCION_GRUPO
        lOPCION_GRUPO = Me.mComponente.ObtenerListaPorOPCION_MENU(ID_OPCION_MENU)
        If lOPCION_GRUPO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorOPCION_MENU") = True
        Me.ViewState("ID_OPCION_MENU") = ID_OPCION_MENU
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lOPCION_GRUPO
        Me.gvLista.DataBind()
    ...
    Public Function CargarDatosPorGRUPO_USUARIO(ByVal ID_GRUPO_USUARIO As Decimal) As Integer
        Dim lOPCION_GRUPO As listaOPCION_GRUPO
        lOPCION_GRUPO = Me.mComponente.ObtenerListaPorGRUPO_USUARIO(ID_GRUPO_USUARIO)
        If lOPCION_GRUPO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorGRUPO_USUARIO") = True
        Me.ViewState("ID_GRUPO_USUARIO") = ID_GRUPO_USUARIO
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lOPCION_GRUPO
        Me.gvLista.DataBind()
    ...
    Private lDdlOPCION_MENU As SGAFP.WebUC.ddlOPCION_MENU
    Private lDdlGRUPO_USUARIO As SGAFP.WebUC.ddlGRUPO_USUARIO
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_OPCION_GRUPO As Label
            mLabelID_OPCION_GRUPO = e.Row.FindControl("Label_ID_OPCION_GRUPO")
            mLabelID_OPCION_GRUPO.Visible = Not Me.PermitirEditar
            lbDetalle.Visible = Me.PermitirEditar
            If Me.VerID_OPCION_MENU Then
                Dim mDdlOPCION_MENU As SGAFP.WebUC.ddlOPCION_MENU
                mDdlOPCION_MENU = e.Row.FindControl("DdlOPCION_MENU1")
                If lDdlOPCION_MENU Is Nothing Then
                    lDdlOPCION_MENU = New SGAFP.WebUC.ddlOPCION_MENU
                    lDdlOPCION_MENU.Recuperar()
                End If
                Dim mOPCION_MENU As String
                mOPCION_MENU = CType(e.Row.FindControl("Label_ID_OPCION_MENU1"), Label).Text
                Dim lItem As ListItem = lDdlOPCION_MENU.Items.FindByValue(mOPCION_MENU)
                If mOPCION_MENU <> "" And Not lItem Is Nothing Then
                    mDdlOPCION_MENU.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlOPCION_MENU.SelectedValue = mOPCION_MENU
                End If
            End If
            If Me.VerID_GRUPO_USUARIO Then
                Dim mDdlGRUPO_USUARIO As SGAFP.WebUC.ddlGRUPO_USUARIO
                mDdlGRUPO_USUARIO = e.Row.FindControl("DdlGRUPO_USUARIO1")
                If lDdlGRUPO_USUARIO Is Nothing Then
                    lDdlGRUPO_USUARIO = New SGAFP.WebUC.ddlGRUPO_USUARIO
                    lDdlGRUPO_USUARIO.Recuperar()
                End If
                Dim mGRUPO_USUARIO As String
                mGRUPO_USUARIO = CType(e.Row.FindControl("Label_ID_GRUPO_USUARIO1"), Label).Text
                Dim lItem As ListItem = lDdlGRUPO_USUARIO.Items.FindByValue(mGRUPO_USUARIO)
                If mGRUPO_USUARIO <> "" And Not lItem Is Nothing Then
                    mDdlGRUPO_USUARIO.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlGRUPO_USUARIO.SelectedValue = mGRUPO_USUARIO
                End If
            End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarOPCION_GRUPO(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Protected Sub gvLista_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gvLista.PageIndexChanging
        ...
        If Me.ViewState("PorOPCION_MENU") Then
            Me.CargarDatosPorOPCION_MENU(Me.ViewState("ID_OPCION_MENU"))
            Return
        End If
        If Me.ViewState("PorGRUPO_USUARIO") Then
            Me.CargarDatosPorGRUPO_USUARIO(Me.ViewState("ID_GRUPO_USUARIO"))
            Return
        End If
        Me.CargarDatos()
    End Sub

    Public Function DevolverSeleccionados() As listaOPCION_GRUPO
        Dim mLista As New listaOPCION_GRUPO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_OPCION_GRUPO = CInt(CType(mRow.FindControl("Label_ID_OPCION_GRUPO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
