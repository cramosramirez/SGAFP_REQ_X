...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaNIVEL_ACADEMICO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla NIVEL_ACADEMICO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderNIVEL_ACADEMICO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lNIVEL_ACADEMICO As listaNIVEL_ACADEMICO
        lNIVEL_ACADEMICO = Me.mComponente.ObtenerLista()
        If lNIVEL_ACADEMICO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lNIVEL_ACADEMICO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelNIVEL_ACADEMICO As Label
            mLabelNIVEL_ACADEMICO = e.Row.FindControl("Label_NIVEL_ACADEMICO")
            mLabelNIVEL_ACADEMICO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarNIVEL_ACADEMICO(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaNIVEL_ACADEMICO
        Dim mLista As New listaNIVEL_ACADEMICO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.NOMBRE_NIVEL_ACADEMICO = CInt(CType(mRow.FindControl("Label_NIVEL_ACADEMICO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
