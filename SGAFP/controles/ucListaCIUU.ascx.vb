...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CIUU
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderDESCRIPCION_CIIU() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lCIUU As listaCIUU
        lCIUU = Me.mComponente.ObtenerLista()
        If lCIUU is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCIUU
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCIUU As Label
            mLabelCIUU = e.Row.FindControl("Label_CIUU")
            mLabelCIUU.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarCIUU(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaCIUU
        Dim mLista As New listaCIUU
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CIUU = CInt(CType(mRow.FindControl("Label_CIUU"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
