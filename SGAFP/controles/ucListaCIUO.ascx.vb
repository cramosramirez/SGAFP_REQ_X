...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CIUO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderCIUO() As String
        Get
    ...
    Public Property HeaderDESCRIPCION_NACIONAL() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lCIUO As listaCIUO
        lCIUO = Me.mComponente.ObtenerLista()
        If lCIUO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCIUO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCIUO As Label
            mLabelCIUO = e.Row.FindControl("Label_CIUO")
            mLabelCIUO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarCIUO(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaCIUO
        Dim mLista As New listaCIUO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CIUO = CInt(CType(mRow.FindControl("Label_CIUO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
