...
<%@ Register tagprefix="uc1" tagname="ucListaCONTRATO_COMPRA_PAGO_ASISTE" Src="~/controles/ucListaCONTRATO_COMPRA_PAGO_ASISTE.ascx" %>
...
<table>
    <tr>
        ...
        <td>
            <dx:ASPxTextBox ID="txtNO_CONTRATO_COMPRA" Font-Bold="true" runat="server" MaxLength="100" Width="100%">
                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black" />
            </dx:ASPxTextBox>
        </td>
    </tr>
    ...
    <tr>
        ...
        <th colspan="3" >
            <dx:ASPxComboBox ID="cbxFORMA_PAGO" DataSourceID="odsFORMA_PAGO" runat="server" AutoPostBack="true" ValueField="ID_FORMA_PAGO" ValueType="System.Int32" TextField="NOMBRE_PAGO"  Width="100%" >
            </dx:ASPxComboBox>
        </th>
    </tr>  
    <tr>
    ...
    <tr>
        <th colspan="4" >
             <dx:ASPxPageControl ID="TabSolicitud" runat="server" ClientInstanceName="TabSolicitud" 
                ...
                Font-Names="Verdana,Arial,Tahoma"  Font-Size="XX-Small" CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange" SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css" TabSpacing="2px" ActiveTabIndex="1" >                 
                        ...
                        <ContentCollection>    
                            <dx:ContentControl ID="ContentControl2" runat="server">
                                <table>
                                    ...
                                    <tr>
                                        <th colspan="3" >            
                                            <uc1:ucListaCONTRATO_COMPRA_PAGO_ASISTE id="ucListaCONTRATO_COMPRA_PAGO_ASISTE1" PermitirEditarInline="true" PermitirEliminar="true" runat="server"></uc1:ucListaCONTRATO_COMPRA_PAGO_ASISTE>
                                        </th>
                                    </tr>                                   
                                </table>
                            </dx:ContentControl>
