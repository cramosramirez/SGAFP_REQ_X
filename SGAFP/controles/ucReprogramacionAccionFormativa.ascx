<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReprogramacionAccionFormativa.ascx.vb" Inherits="controles_ucReprogramacionAccionFormativa" %>
...
<dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel1" 
    ...
    <dx:PanelContent ID="PanelContent1" runat="server">    
             ...
             <table border="0" cellpadding="2" cellspacing="0" width="100%" >
                <tr>
                    <td>
                    <dx:ASPxGridView ID="dgProgCurso" ClientInstanceName="dgProgCurso" runat="server" AutoGenerateColumns="False" Width="100%" >
                            <Columns>                                                                
