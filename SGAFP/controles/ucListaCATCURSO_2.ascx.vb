...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaCATCURSO_2
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CATCURSO_2
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderID_CURSO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lCATCURSO_2 As listaCATCURSO_2
        lCATCURSO_2 = Me.mComponente.ObtenerLista()
        If lCATCURSO_2 is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCATCURSO_2
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_CURSO As Label
            mLabelID_CURSO = e.Row.FindControl("Label_ID_CURSO")
            mLabelID_CURSO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarCATCURSO_2(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaCATCURSO_2
        Dim mLista As New listaCATCURSO_2
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_CURSO = CInt(CType(mRow.FindControl("Label_ID_CURSO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
