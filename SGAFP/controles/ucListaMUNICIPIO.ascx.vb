...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaMUNICIPIO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla MUNICIPIO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaMUNICIPIO
    Inherits ucBase
    ...
    Public Event Editando(ByVal CODIGO_MUNICIPIO As String, ByVal CODIGO_REGION As String, ByVal CODIGO_DEPARTAMENTO As String) 
...
#Region"Propiedades"
    ...
    Public Property CODIGO_REGION() As String
        ...
        Set(ByVal Value As String)
            ...
            If Not Me.ViewState("CODIGO_REGION") Is Nothing Then Me.ViewState.Remove("CODIGO_REGION")
            Me.ViewState.Add("CODIGO_REGION", Value)
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lMUNICIPIO As listaMUNICIPIO
        lMUNICIPIO = Me.mComponente.ObtenerLista(CODIGO_REGION, CODIGO_DEPARTAMENTO)
        ...
        Me.gvLista.DataSource = lMUNICIPIO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Public Function CargarDatosPorDEPARTAMENTO(ByVal CODIGO_REGION As String, ByVal CODIGO_DEPARTAMENTO As String) As Integer
        Dim lMUNICIPIO As listaMUNICIPIO
        lMUNICIPIO = Me.mComponente.ObtenerListaPorDEPARTAMENTO(CODIGO_REGION, CODIGO_DEPARTAMENTO)
        If lMUNICIPIO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
    ...
    Protected Sub gvLista_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvLista.RowCommand
        If e.CommandName = "Editar" Then
            RaiseEvent Editando(CODIGO_REGION, CODIGO_DEPARTAMENTO, e.CommandArgument)
        End If
    End Sub
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODIGO_MUNICIPIO As Label
            mLabelCODIGO_MUNICIPIO = e.Row.FindControl("Label_CODIGO_MUNICIPIO")
            mLabelCODIGO_MUNICIPIO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarMUNICIPIO(CODIGO_DEPARTAMENTO, CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Private Sub gvLista_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles gvLista.SelectedIndexChanging
        RaiseEvent Seleccionado(CODIGO_REGION, CODIGO_DEPARTAMENTO, CType(Me.gvLista.Rows(e.NewSelectedIndex).FindControl("LinkButton1"), LinkButton).ToolTip)
    End Sub
    ...
    Public Function DevolverSeleccionados() As listaMUNICIPIO
        Dim mLista As New listaMUNICIPIO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIGO_MUNICIPIO = CInt(CType(mRow.FindControl("Label_CODIGO_MUNICIPIO"), Label).Text)
                mEntidad.CODIGO_DEPARTAMENTO = Me.CODIGO_DEPARTAMENTO
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
