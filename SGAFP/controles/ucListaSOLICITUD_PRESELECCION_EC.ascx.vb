...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaSOLICITUD_PRESELECCION_EC
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLICITUD_PRESELECCION_EC
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLICITUD_PRESELECCION_EC
    Inherits ucListaBase

    Private mComponente As New cSOLICITUD_PRESELECCION_EC
    Public Event Seleccionado(ByVal ID_SOLIC_PRESELEC As Decimal)
    Public Event Editando(ByVal ID_SOLIC_PRESELEC As Decimal)
    Public Event Eliminado(ByVal ID_SOLIC_PRESELEC As Decimal)
...
#Region "Propiedades"
    ...
    Public Property VerID_SOLIC_PRESELEC() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_PRESELEC").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_SOLIC_PRESELEC").Visible = Value
        End Set
    End Property
    ...
    Public Property VerID_TIPO_SELECC() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_TIPO_SELECC").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_TIPO_SELECC").Visible = Value
        End Set
    End Property
    ...
    Public Property VerID_MOTIVO_DEJO_ESTU() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_MOTIVO_DEJO_ESTU").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_MOTIVO_DEJO_ESTU").Visible = Value
        End Set
    End Property

    Public Property VerOTRO_MOTIVO_DEJO_ESTU() As Boolean
        Get
            Return Me.dxgvLista.Columns("OTRO_MOTIVO_DEJO_ESTU").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("OTRO_MOTIVO_DEJO_ESTU").Visible = Value
        End Set
    End Property
    ...
    Public Property VerOCUACT_ESTU_TRAB() As Boolean
        Get
            Return Me.dxgvLista.Columns("OCUACT_ESTU_TRAB").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("OCUACT_ESTU_TRAB").Visible = Value
        End Set
    End Property
    ...
    Public Property VerOCUACT_BUSCA_TRAB() As Boolean
        Get
            Return Me.dxgvLista.Columns("OCUACT_BUSCA_TRAB").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("OCUACT_BUSCA_TRAB").Visible = Value
        End Set
    End Property
    ...
    Public Property VerMANERA_OBT_ING_BECA() As Boolean
        Get
            Return Me.dxgvLista.Columns("MANERA_OBT_ING_BECA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("MANERA_OBT_ING_BECA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerID_INGRESO_MES() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_INGRESO_MES").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_INGRESO_MES").Visible = Value
        End Set
    End Property

    Public Property VerID_TIEMPO_NOTRAB() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_TIEMPO_NOTRAB").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_TIEMPO_NOTRAB").Visible = Value
        End Set
    End Property

    Public Property VerID_ACTI_ECONOMICA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_ACTI_ECONOMICA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_ACTI_ECONOMICA").Visible = Value
        End Set
    End Property

    Public Property VerID_AREA_EMPRESA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_AREA_EMPRESA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_AREA_EMPRESA").Visible = Value
        End Set
    End Property

    Public Property VerID_MOTIVO_DEJO_TRAB() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_MOTIVO_DEJO_TRAB").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_MOTIVO_DEJO_TRAB").Visible = Value
        End Set
    End Property
    ...
    Public Property VerMOTIVO_ELIGIO_CARRERA() As Boolean
        Get
            Return Me.dxgvLista.Columns("MOTIVO_ELIGIO_CARRERA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("MOTIVO_ELIGIO_CARRERA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerAutorizar() As Boolean
        Get
            Return Me.dxgvLista.Columns("colAutorizar").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("colAutorizar").Visible = Value
        End Set
    End Property
    ...
    Public Property VerTIPO_EMPLEO_OTRO() As Boolean
        Get
            Return Me.dxgvLista.Columns("TIPO_EMPLEO_OTRO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("TIPO_EMPLEO_OTRO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerPUESTO_DESEMPENO() As Boolean
        Get
            Return Me.dxgvLista.Columns("PUESTO_DESEMPENO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("PUESTO_DESEMPENO").Visible = Value
        End Set
    End Property

    Public Property VerID_ULT_SALARIO_MES() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_ULT_SALARIO_MES").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_ULT_SALARIO_MES").Visible = Value
        End Set
    End Property

    Public Property HeaderID_SOLIC_PRESELEC() As String
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_PRESELEC").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_SOLIC_PRESELEC").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderID_TIPO_SELECC() As String
        Get
            Return Me.dxgvLista.Columns("ID_TIPO_SELECC").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_TIPO_SELECC").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderID_MOTIVO_DEJO_ESTU() As String
        Get
            Return Me.dxgvLista.Columns("ID_MOTIVO_DEJO_ESTU").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_MOTIVO_DEJO_ESTU").Caption = Value
        End Set
    End Property

    Public Property HeaderOTRO_MOTIVO_DEJO_ESTU() As String
        Get
            Return Me.dxgvLista.Columns("OTRO_MOTIVO_DEJO_ESTU").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("OTRO_MOTIVO_DEJO_ESTU").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderOCUACT_ESTU_TRAB() As String
        Get
            Return Me.dxgvLista.Columns("OCUACT_ESTU_TRAB").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("OCUACT_ESTU_TRAB").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderOCUACT_BUSCA_TRAB() As String
        Get
            Return Me.dxgvLista.Columns("OCUACT_BUSCA_TRAB").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("OCUACT_BUSCA_TRAB").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderMANERA_OBT_ING_BECA() As String
        Get
            Return Me.dxgvLista.Columns("MANERA_OBT_ING_BECA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("MANERA_OBT_ING_BECA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderID_INGRESO_MES() As String
        Get
            Return Me.dxgvLista.Columns("ID_INGRESO_MES").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_INGRESO_MES").Caption = Value
        End Set
    End Property

    Public Property HeaderID_TIEMPO_NOTRAB() As String
        Get
            Return Me.dxgvLista.Columns("ID_TIEMPO_NOTRAB").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_TIEMPO_NOTRAB").Caption = Value
        End Set
    End Property

    Public Property HeaderID_ACTI_ECONOMICA() As String
        Get
            Return Me.dxgvLista.Columns("ID_ACTI_ECONOMICA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_ACTI_ECONOMICA").Caption = Value
        End Set
    End Property

    Public Property HeaderID_AREA_EMPRESA() As String
        Get
            Return Me.dxgvLista.Columns("ID_AREA_EMPRESA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_AREA_EMPRESA").Caption = Value
        End Set
    End Property

    Public Property HeaderID_MOTIVO_DEJO_TRAB() As String
        Get
            Return Me.dxgvLista.Columns("ID_MOTIVO_DEJO_TRAB").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_MOTIVO_DEJO_TRAB").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderMOTIVO_ELIGIO_CARRERA() As String
        Get
            Return Me.dxgvLista.Columns("MOTIVO_ELIGIO_CARRERA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("MOTIVO_ELIGIO_CARRERA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderTIPO_EMPLEO_OTRO() As String
        Get
            Return Me.dxgvLista.Columns("TIPO_EMPLEO_OTRO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("TIPO_EMPLEO_OTRO").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderPUESTO_DESEMPENO() As String
        Get
            Return Me.dxgvLista.Columns("PUESTO_DESEMPENO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("PUESTO_DESEMPENO").Caption = Value
        End Set
    End Property

    Public Property HeaderID_ULT_SALARIO_MES() As String
        Get
            Return Me.dxgvLista.Columns("ID_ULT_SALARIO_MES").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_ULT_SALARIO_MES").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPorCriterios(ByVal ID_PROVEEDOR_AF As Decimal, _
        ...
        Me.odsCriterios.SelectParameters("CODIGO").DefaultValue = CODIGO
        Me.odsCriterios.SelectParameters("NO_GRUPO").DefaultValue = NO_GRUPO.ToString
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorPARTICIPANTE(ByVal ID_PARTICIPANTE As Decimal, ByVal DUI As String, ByVal NIT As String) As Integer
        Me.odsListaPorPARTICIPANTE.SelectParameters("ID_PARTICIPANTE").DefaultValue = ID_PARTICIPANTE.ToString()
        Me.odsListaPorPARTICIPANTE.SelectParameters("DUI").DefaultValue = DUI.ToString()
        Me.odsListaPorPARTICIPANTE.SelectParameters("NIT").DefaultValue = NIT.ToString()
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla GRUPO_SELECCION
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorGRUPO_SELECCION(ByVal ID_GRUPO_SELEC As Decimal) As Integer
        Me.odsListaPorGRUPO_SELECCION.SelectParameters("ID_GRUPO_SELEC").DefaultValue = ID_GRUPO_SELEC.ToString()
        Me.odsListaPorGRUPO_SELECCION.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorGRUPO_SELECCION.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorGRUPO_SELECCION.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorGRUPO_SELECCION.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorGRUPO_SELECCION.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorGRUPO_SELECCION"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla TIPO_SELECC
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorTIPO_SELECC(ByVal ID_TIPO_SELECC As Decimal) As Integer
        Me.odsListaPorTIPO_SELECC.SelectParameters("ID_TIPO_SELECC").DefaultValue = ID_TIPO_SELECC.ToString()
        Me.odsListaPorTIPO_SELECC.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorTIPO_SELECC.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorTIPO_SELECC.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorTIPO_SELECC.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorTIPO_SELECC.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorTIPO_SELECC"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla MOTIVO_DEJO_ESTU
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorMOTIVO_DEJO_ESTU(ByVal ID_MOTIVO_DEJO_ESTU As Decimal) As Integer
        Me.odsListaPorMOTIVO_DEJO_ESTU.SelectParameters("ID_MOTIVO_DEJO_ESTU").DefaultValue = ID_MOTIVO_DEJO_ESTU.ToString()
        Me.odsListaPorMOTIVO_DEJO_ESTU.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorMOTIVO_DEJO_ESTU.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorMOTIVO_DEJO_ESTU.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorMOTIVO_DEJO_ESTU.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorMOTIVO_DEJO_ESTU.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorMOTIVO_DEJO_ESTU"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla INGRESO_MES
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorINGRESO_MES(ByVal ID_INGRESO_MES As Decimal) As Integer
        Me.odsListaPorINGRESO_MES.SelectParameters("ID_INGRESO_MES").DefaultValue = ID_INGRESO_MES.ToString()
        Me.odsListaPorINGRESO_MES.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorINGRESO_MES.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorINGRESO_MES.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorINGRESO_MES.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorINGRESO_MES.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorINGRESO_MES"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla TIEMPO_NOTRAB
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorTIEMPO_NOTRAB(ByVal ID_TIEMPO_NOTRAB As Decimal) As Integer
        Me.odsListaPorTIEMPO_NOTRAB.SelectParameters("ID_TIEMPO_NOTRAB").DefaultValue = ID_TIEMPO_NOTRAB.ToString()
        Me.odsListaPorTIEMPO_NOTRAB.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorTIEMPO_NOTRAB.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorTIEMPO_NOTRAB.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorTIEMPO_NOTRAB.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorTIEMPO_NOTRAB.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorTIEMPO_NOTRAB"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla ACTI_ECONOMICA
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorACTI_ECONOMICA(ByVal ID_ACTI_ECONOMICA As Decimal) As Integer
        Me.odsListaPorACTI_ECONOMICA.SelectParameters("ID_ACTI_ECONOMICA").DefaultValue = ID_ACTI_ECONOMICA.ToString()
        Me.odsListaPorACTI_ECONOMICA.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorACTI_ECONOMICA.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorACTI_ECONOMICA.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorACTI_ECONOMICA.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorACTI_ECONOMICA.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorACTI_ECONOMICA"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla AREA_EMPRESA
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorAREA_EMPRESA(ByVal ID_AREA_EMPRESA As Decimal) As Integer
        Me.odsListaPorAREA_EMPRESA.SelectParameters("ID_AREA_EMPRESA").DefaultValue = ID_AREA_EMPRESA.ToString()
        Me.odsListaPorAREA_EMPRESA.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorAREA_EMPRESA.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorAREA_EMPRESA.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorAREA_EMPRESA.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorAREA_EMPRESA.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorAREA_EMPRESA"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla SOLICITUD_PRESELECCION_EC
    ''' filtrado por la tabla MOTIVO_DEJO_TRAB
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorMOTIVO_DEJO_TRAB(ByVal ID_MOTIVO_DEJO_TRAB As Decimal) As Integer
        Me.odsListaPorMOTIVO_DEJO_TRAB.SelectParameters("ID_MOTIVO_DEJO_TRAB").DefaultValue = ID_MOTIVO_DEJO_TRAB.ToString()
        Me.odsListaPorMOTIVO_DEJO_TRAB.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorMOTIVO_DEJO_TRAB.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorMOTIVO_DEJO_TRAB.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorMOTIVO_DEJO_TRAB.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorMOTIVO_DEJO_TRAB.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorMOTIVO_DEJO_TRAB"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_SOLIC_PRESELEC")
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        ...
        End If
        If e.CommandArgs.CommandName = "Autorizar" Then
            Dim bSolic As New cSOLICITUD_PRESELECCION_EC
            Dim lSolic As SOLICITUD_PRESELECCION_EC
            lSolic = (New cSOLICITUD_PRESELECCION_EC).ObtenerSOLICITUD_PRESELECCION_EC(e.KeyValue)

            If lSolic IsNot Nothing Then
                lSolic.AUTORIZADO = 1
                lSolic.MOTIVO_AUTORIZADO = "AUTORIZADO POR TECNICO"
                lSolic.USUARIO_AUTORIZO = Me.ObtenerUsuario
                lSolic.FECHA_AITORIZA = Now
                bSolic.ActualizarSOLICITUD_PRESELECCION_EC(lSolic)
            End If
        End If
        If e.CommandArgs.CommandName = "Eliminar" Then
            Dim b As New cSOLICITUD_PRESELECCION_EC

            b.EliminarSOLICITUD_PRESELECCION_EC(e.KeyValue)
            Me.dxgvLista.DataBind()
            Me.AsignarMensaje("Registro eliminado", False, True)
            RaiseEvent Eliminado(e.KeyValue)
        End If
    End Sub

    Public Function DevolverSeleccionados() As listaSOLICITUD_PRESELECCION_EC
        Dim mLista As New listaSOLICITUD_PRESELECCION_EC
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_SOLIC_PRESELEC")
            Dim lEntidad As SOLICITUD_PRESELECCION_EC = (New cSOLICITUD_PRESELECCION_EC).ObtenerSOLICITUD_PRESELECCION_EC(llave)
            If lEntidad IsNot Nothing Then mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLICITUD_PRESELECCION_EC = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLICITUD_PRESELECCION_EC)

            If Me.mComponente.EliminarSOLICITUD_PRESELECCION_EC(lEntidad.ID_SOLIC_PRESELEC) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridView.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "NUM_CONTRATO" Then
            Dim lGrupoSeleccion As GRUPO_SELECCION = (New cGRUPO_SELECCION).ObtenerGRUPO_SELECCION(e.GetListSourceFieldValue("ID_GRUPO_SELEC"))
            If lGrupoSeleccion IsNot Nothing Then
                Dim lEntidad As ACCION_CONTRATADA = (New cACCION_CONTRATADA).ObtenerACCION_CONTRATADA(lGrupoSeleccion.ID_ACCION_CONTRATADA)
        ...
        ElseIf e.Column.FieldName = "CODIGO" Then
            Dim lGrupoSeleccion As GRUPO_SELECCION = (New cGRUPO_SELECCION).ObtenerGRUPO_SELECCION(e.GetListSourceFieldValue("ID_GRUPO_SELEC"))
            If lGrupoSeleccion IsNot Nothing Then
                e.Value = lGrupoSeleccion.CODIGO
            End If
        ElseIf e.Column.FieldName = "NO_GRUPO" Then
            Dim lGrupoSeleccion As GRUPO_SELECCION = (New cGRUPO_SELECCION).ObtenerGRUPO_SELECCION(e.GetListSourceFieldValue("ID_GRUPO_SELEC"))
            If lGrupoSeleccion IsNot Nothing Then
                e.Value = lGrupoSeleccion.NO_GRUPO.ToString
            End If
        ElseIf e.Column.FieldName = "CURSO" Then
            Dim lGrupoSeleccion As GRUPO_SELECCION = (New cGRUPO_SELECCION).ObtenerGRUPO_SELECCION(e.GetListSourceFieldValue("ID_GRUPO_SELEC"))
            If lGrupoSeleccion IsNot Nothing Then
                ...
                End If
            End If
        ElseIf e.Column.FieldName = "TIPO_SOLICITUD" Then
            Dim lEntidad As TIPO_SELECC = (New cTIPO_SELECC).ObtenerTIPO_SELECC(e.GetListSourceFieldValue("ID_TIPO_SELECC"))
            If lEntidad IsNot Nothing Then
    ...
    Protected Sub dxgvLista_HtmlRowCreated(sender As Object, e As ASPxGridViewTableRowEventArgs) Handles dxgvLista.HtmlRowCreated
        If e.RowType = DevExpress.Web.ASPxGridView.GridViewRowType.Data Then
            If Me.VerAutorizar Then
                Dim lbSeleccionar As ImageButton
                Dim lSolic As SOLICITUD_PRESELECCION_EC

                lbSeleccionar = Me.dxgvLista.FindRowCellTemplateControl(e.VisibleIndex, Nothing, "lbtnAutorizar")
                lSolic = (New cSOLICITUD_PRESELECCION_EC).ObtenerSOLICITUD_PRESELECCION_EC(e.KeyValue)

                If lbSeleccionar IsNot Nothing AndAlso lSolic IsNot Nothing Then
                    If lSolic.REQUI_AUTORIZACION = 1 AndAlso lSolic.AUTORIZADO <> 1 Then
