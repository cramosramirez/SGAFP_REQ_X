...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucVistaDetalleINFORME_FINAL_AF
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucVistaDetalleINFORME_FINAL_AF
    Inherits ucBase
...
#Region"Propiedades"
    ...
    Public Property ID_INFORME_FINAL() As Decimal
        Get
            Return Me.txtID_INFORME_FINAL.Text
        End Get
        Set(ByVal Value As Decimal)
            Me._ID_INFORME_FINAL = Value
            Me.txtID_INFORME_FINAL.Text = CStr(Value)
    ...
    Private mEntidad As INFORME_FINAL_AF
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Carga la información del registro de la tabla INFORME_FINAL_AF
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New INFORME_FINAL_AF
        mEntidad.ID_INFORME_FINAL = ID_INFORME_FINAL
 
        If mComponente.ObtenerINFORME_FINAL_AF(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener Registro.")
            Return
        End If
        Me.txtID_INFORME_FINAL.Text = mEntidad.ID_INFORME_FINAL.ToString()
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Guarda la información del registro en la tabla INFORME_FINAL_AF
    ''' </summary>
    ''' <returns>
    ''' ""                              : Si no existe error
    ...
    Public Function Actualizar() As String
        ...
        mEntidad = New INFORME_FINAL_AF
        If Me._nuevo Then
            mEntidad.ID_INFORME_FINAL = 0
        Else
            mEntidad.ID_INFORME_FINAL = CInt(Me.txtID_INFORME_FINAL.Text)
        End If
        ...
        If mComponente.ActualizarINFORME_FINAL_AF(mEntidad) <> 1 Then
