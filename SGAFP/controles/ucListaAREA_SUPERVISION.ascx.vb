...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaAREA_SUPERVISION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla AREA_SUPERVISION
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderAREA_SUPERVISION() As String
        Get
    ...
    Public Property HeaderSANCIONATORIA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lAREA_SUPERVISION As listaAREA_SUPERVISION
        lAREA_SUPERVISION = Me.mComponente.ObtenerLista()
        If lAREA_SUPERVISION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lAREA_SUPERVISION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_AREA_SUPERVISION As Label
            mLabelID_AREA_SUPERVISION = e.Row.FindControl("Label_ID_AREA_SUPERVISION")
            mLabelID_AREA_SUPERVISION.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarAREA_SUPERVISION(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaAREA_SUPERVISION
        Dim mLista As New listaAREA_SUPERVISION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_AREA_SUPERVISION = CInt(CType(mRow.FindControl("Label_ID_AREA_SUPERVISION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
