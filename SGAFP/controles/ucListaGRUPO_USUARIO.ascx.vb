...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaGRUPO_USUARIO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla GRUPO_USUARIO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderROL_USUARIO() As String
        Get
    ...
    Public Property HeaderNIVEL() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lGRUPO_USUARIO As listaGRUPO_USUARIO
        lGRUPO_USUARIO = Me.mComponente.ObtenerLista()
        If lGRUPO_USUARIO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lGRUPO_USUARIO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_GRUPO_USUARIO As Label
            mLabelID_GRUPO_USUARIO = e.Row.FindControl("Label_ID_GRUPO_USUARIO")
            mLabelID_GRUPO_USUARIO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarGRUPO_USUARIO(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaGRUPO_USUARIO
        Dim mLista As New listaGRUPO_USUARIO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_GRUPO_USUARIO = CInt(CType(mRow.FindControl("Label_ID_GRUPO_USUARIO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
