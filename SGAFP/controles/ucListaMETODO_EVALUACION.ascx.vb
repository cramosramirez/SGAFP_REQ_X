...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaMETODO_EVALUACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla METODO_EVALUACION
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderID_METODO_EVALUACION() As String
        Get
    ...
    Public Property HeaderMETODO_EVALUACION() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lMETODO_EVALUACION As listaMETODO_EVALUACION
        lMETODO_EVALUACION = Me.mComponente.ObtenerLista()
        If lMETODO_EVALUACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lMETODO_EVALUACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_METODO_EVALUACION As Label
            mLabelID_METODO_EVALUACION = e.Row.FindControl("Label_ID_METODO_EVALUACION")
            mLabelID_METODO_EVALUACION.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarMETODO_EVALUACION(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaMETODO_EVALUACION
        Dim mLista As New listaMETODO_EVALUACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_METODO_EVALUACION = CInt(CType(mRow.FindControl("Label_ID_METODO_EVALUACION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
