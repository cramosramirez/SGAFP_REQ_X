<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleDEPARTAMENTO.ascx.vb" Inherits="controles_ucVistaDetalleDEPARTAMENTO" %>
...
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<TR runat="server" id="trCODIGO_DEPARTAMENTO">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCODIGO_DEPARTAMENTO" runat="server" Width="70px" MaxLength="2"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
