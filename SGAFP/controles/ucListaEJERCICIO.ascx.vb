...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaEJERCICIO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla EJERCICIO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderETIQUETA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lEJERCICIO As listaEJERCICIO
        lEJERCICIO = Me.mComponente.ObtenerLista()
        If lEJERCICIO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lEJERCICIO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_EJERCICIO As Label
            mLabelID_EJERCICIO = e.Row.FindControl("Label_ID_EJERCICIO")
            mLabelID_EJERCICIO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarEJERCICIO(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaEJERCICIO
        Dim mLista As New listaEJERCICIO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_EJERCICIO = CInt(CType(mRow.FindControl("Label_ID_EJERCICIO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
