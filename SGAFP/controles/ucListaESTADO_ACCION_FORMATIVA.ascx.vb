...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaESTADO_ACCION_FORMATIVA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla ESTADO_ACCION_FORMATIVA
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_ESTADO_AF() As String
        Get
    ...
    Public Property HeaderESTADO_INICIAL() As String
        Get
    ...
    Public Property HeaderPERMITE_INSCRIPCION() As String
        Get
    ...
    Public Property HeaderESTADO_FINAL() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lESTADO_ACCION_FORMATIVA As listaESTADO_ACCION_FORMATIVA
        lESTADO_ACCION_FORMATIVA = Me.mComponente.ObtenerLista()
        If lESTADO_ACCION_FORMATIVA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lESTADO_ACCION_FORMATIVA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODIGO_ESTADO_AF As Label
            mLabelCODIGO_ESTADO_AF = e.Row.FindControl("Label_CODIGO_ESTADO_AF")
            mLabelCODIGO_ESTADO_AF.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarESTADO_ACCION_FORMATIVA(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaESTADO_ACCION_FORMATIVA
        ...
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIGO_ESTADO_AF = CInt(CType(mRow.FindControl("Label_CODIGO_ESTADO_AF"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
