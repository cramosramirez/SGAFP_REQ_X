<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaSistemas.ascx.vb" Inherits="controles_ucListaSistemas" %>
<%@ Register assembly="DevExpress.Web.ASPxGridView.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxGridView" tagprefix="dx" %>
<%@ Register assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxEditors" tagprefix="dx" %>
<%@ Register src="ucVistaDetalleSistemas.ascx" tagname="ucVistaDetalleSistemas" tagprefix="uc1" %>
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" DataSourceID="odsLista" KeyFieldName="IdSistema">
        ...
        <dx:GridViewDataTextColumn VisibleIndex="1">
            <DataItemTemplate>
                <asp:LinkButton ID="lbtnEditar" runat="server" CommandName="Editar" 
                    CommandArgument='<%# Bind("IdSistema") %>'>Editar</asp:LinkButton>
                &nbsp;<asp:LinkButton ID="lbtnSeleccionar" runat="server" 
                    CommandArgument='<%# Bind("IdSistema") %>' CommandName="Seleccionar" 
                    Visible="False">Seleccionar</asp:LinkButton>
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="IdSistema" ReadOnly="True" VisibleIndex="2" Caption="Id Sistema" />
        <dx:GridViewDataTextColumn FieldName="NombreSistema" VisibleIndex="3" Caption="Nombre Sistema" />
    ...
    <Templates>
        <EditForm>
            <uc1:ucVistaDetalleSistemas ID="ucVistaDetalleSistemas1" runat="server" 
                IdSistema1='<%# Bind("IdSistema") %>' NombreSistema='<%# Bind("NombreSistema") %>' />
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    ...
    <InsertParameters>
        <asp:Parameter DefaultValue="0" Name="IdSistema" Type="Int32" />
        <asp:Parameter Name="NombreSistema" Type="String" />
    </InsertParameters>
    <UpdateParameters>
