...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaUNIDAD_ORGANIZATIVA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla UNIDAD_ORGANIZATIVA
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property VerCODIGO_UNIDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("CODIGO_UNIDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CODIGO_UNIDAD").Visible = Value
        End Set
    End Property

    Public Property VerID_UNIDAD_PADRE() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_UNIDAD_PADRE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_UNIDAD_PADRE").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderCODIGO_UNIDAD() As String
        Get
            Return Me.dxgvLista.Columns("CODIGO_UNIDAD").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CODIGO_UNIDAD").Caption = Value
        End Set
    End Property

    Public Property HeaderID_UNIDAD_PADRE() As String
        Get
            Return Me.dxgvLista.Columns("ID_UNIDAD_PADRE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_UNIDAD_PADRE").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_UNIDAD_ORGANIZATIVA")
    ...
    Public Function DevolverSeleccionados() As listaUNIDAD_ORGANIZATIVA
        Dim mLista As New listaUNIDAD_ORGANIZATIVA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_UNIDAD_ORGANIZATIVA")
            Dim lEntidad As New UNIDAD_ORGANIZATIVA
            lEntidad.ID_UNIDAD_ORGANIZATIVA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As UNIDAD_ORGANIZATIVA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), UNIDAD_ORGANIZATIVA)

            If Me.mComponente.EliminarUNIDAD_ORGANIZATIVA(lEntidad.ID_UNIDAD_ORGANIZATIVA) <> 1 Then
