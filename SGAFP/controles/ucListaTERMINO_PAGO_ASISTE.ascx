<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaTERMINO_PAGO_ASISTE.ascx.vb" Inherits="controles_ucListaTERMINO_PAGO_ASISTE" %>
<%@ Register assembly="DevExpress.Web.ASPxGridView.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxGridView" tagprefix="dx" %>
<%@ Register assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxEditors" tagprefix="dx" %>
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" KeyFieldName="ID_TERMINO_ASISTE" Width="100%" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" CssPostfix="Office2010Blue">
   <SettingsPager PageSize="15">
    ...
    <Columns>
       <dx:GridViewCommandColumn Name="Edicion" EditButton-Visible="true" ButtonType="Image" VisibleIndex="1" Visible="False" CellStyle-HorizontalAlign="Center" Width="30px" Caption=" "  >
        ...
        <dx:GridViewDataTextColumn FieldName="ID_TERMINO_ASISTE" ReadOnly="True" VisibleIndex="2" Caption="Id contra asiste" Visible="false" />
        ...
        <dx:GridViewDataTextColumn VisibleIndex="12" Name="Eliminar"  Caption="" Width="30px"  >
            <DataItemTemplate>
                <asp:ImageButton runat="server" CommandName="Eliminar" CommandArgument='<%# Bind("ID_TERMINO_ASISTE")%>' ID="imgEliminar" ImageUrl="../imagenes/Close-2-icon.png" />             
            </DataItemTemplate>
...
<asp:ObjectDataSource ID="odsTERMINO_PAGO_ASISTEcache" runat="server" TypeName="cTERMINO_PAGO_ASISTEcache"     
    SelectMethod="ObtenerLista" UpdateMethod="Actualizar" DeleteMethod="Eliminar"  >       
     <SelectParameters>             
        <asp:Parameter Name="nombreSesion_ucListaTERMINO_PAGO_ASISTE" Type="String" />
     </SelectParameters>     
     <UpdateParameters>    
        <asp:Parameter Name="ID_TERMINO_ASISTE" Type="Decimal" />
