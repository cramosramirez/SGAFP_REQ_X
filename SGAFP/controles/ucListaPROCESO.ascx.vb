...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaPROCESO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROCESO
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_PROCESO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lPROCESO As listaPROCESO
        lPROCESO = Me.mComponente.ObtenerLista()
        If lPROCESO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lPROCESO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            mLabelCODIGO_PROCESO = e.Row.FindControl("Label_CODIGO_PROCESO")
            mLabelCODIGO_PROCESO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarPROCESO(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaPROCESO
        Dim mLista As New listaPROCESO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIGO_PROCESO = CInt(CType(mRow.FindControl("Label_CODIGO_PROCESO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
