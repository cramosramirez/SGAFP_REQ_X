...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaPROGRAMA_FORMACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROGRAMA_FORMACION
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property VerID_PROGRAMA_FORMACION() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_PROGRAMA_FORMACION").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_PROGRAMA_FORMACION").Visible = Value
        End Set
    End Property
    ...
    Public Property VerPORC_ASISTENCIA_MINIMA() As Boolean
        Get
            Return Me.dxgvLista.Columns("PORC_ASISTENCIA_MINIMA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("PORC_ASISTENCIA_MINIMA").Visible = Value
        End Set
    End Property

    Public Property VerNOTA_MINIMA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOTA_MINIMA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOTA_MINIMA").Visible = Value
        End Set
    End Property

    Public Property VerID_TIPO_PAGO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_TIPO_PAGO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_TIPO_PAGO").Visible = Value
        End Set
    End Property

    Public Property HeaderID_PROGRAMA_FORMACION() As String
        Get
            Return Me.dxgvLista.Columns("ID_PROGRAMA_FORMACION").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_PROGRAMA_FORMACION").Caption = Value
        End Set
    End Property

    Public Property HeaderNOMBRE_PROGRAMA_FORMACION() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_PROGRAMA_FORMACION").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_PROGRAMA_FORMACION").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderPORC_ASISTENCIA_MINIMA() As String
        Get
            Return Me.dxgvLista.Columns("PORC_ASISTENCIA_MINIMA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("PORC_ASISTENCIA_MINIMA").Caption = Value
        End Set
    End Property

    Public Property HeaderNOTA_MINIMA() As String
        Get
            Return Me.dxgvLista.Columns("NOTA_MINIMA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOTA_MINIMA").Caption = Value
        End Set
    End Property

    Public Property HeaderID_TIPO_PAGO() As String
        Get
            Return Me.dxgvLista.Columns("ID_TIPO_PAGO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_TIPO_PAGO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPorPROGRAMA_FORMACION_TIPOPAGO(ByVal ID_TIPO_PAGO As Decimal) As Integer
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.SelectParameters("ID_TIPO_PAGO").DefaultValue = ID_TIPO_PAGO.ToString()
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorPROGRAMA_FORMACION_TIPOPAGO.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorPROGRAMA_FORMACION_TIPOPAGO"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PROGRAMA_FORMACION")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_PROGRAMA_FORMACION")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaPROGRAMA_FORMACION
        Dim mLista As New listaPROGRAMA_FORMACION
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PROGRAMA_FORMACION")
            Dim lEntidad As New PROGRAMA_FORMACION
            lEntidad.ID_PROGRAMA_FORMACION = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PROGRAMA_FORMACION = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PROGRAMA_FORMACION)

            If Me.mComponente.EliminarPROGRAMA_FORMACION(lEntidad.ID_PROGRAMA_FORMACION) <> 1 Then
