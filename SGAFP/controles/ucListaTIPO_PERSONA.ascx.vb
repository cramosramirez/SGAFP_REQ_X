...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaTIPO_PERSONA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_PERSONA
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderTIPO_PERSONA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_PERSONA As listaTIPO_PERSONA
        lTIPO_PERSONA = Me.mComponente.ObtenerLista()
        If lTIPO_PERSONA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_PERSONA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPO_PERSONA As Label
            mLabelID_TIPO_PERSONA = e.Row.FindControl("Label_ID_TIPO_PERSONA")
            mLabelID_TIPO_PERSONA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_PERSONA(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaTIPO_PERSONA
        Dim mLista As New listaTIPO_PERSONA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_PERSONA = CInt(CType(mRow.FindControl("Label_ID_TIPO_PERSONA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
