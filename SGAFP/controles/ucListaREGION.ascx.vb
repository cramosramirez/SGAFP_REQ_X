...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla REGION
''' </summary>
''' <remarks>
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lREGION As listaREGION
        lREGION = Me.mComponente.ObtenerLista()
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            mLabelCODIGO_REGION = e.Row.FindControl("Label_CODIGO_REGION")
            mLabelCODIGO_REGION.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarREGION(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaREGION
        Dim mLista As New listaREGION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIGO_REGION = CInt(CType(mRow.FindControl("Label_CODIGO_REGION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
