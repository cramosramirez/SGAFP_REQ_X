...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaESTADO_INFORME_AF
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla ESTADO_INFORME_AF
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaESTADO_INFORME_AF
    Inherits ucListaBase
 
    Private mComponente As New cESTADO_INFORME_AF
    Public Event Seleccionado(ByVal ID_ESTADO_INFORME As Decimal) 
    Public Event Editando(ByVal ID_ESTADO_INFORME As Decimal) 
...
#Region"Propiedades"
    ...
    Public Property VerID_FASE_ESTADO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_FASE_ESTADO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_FASE_ESTADO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerDESCRIPCION_ESTADO() As Boolean
        Get
            Return Me.dxgvLista.Columns("DESCRIPCION_ESTADO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("DESCRIPCION_ESTADO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_FASE_ESTADO() As String
        Get
            Return Me.dxgvLista.Columns("ID_FASE_ESTADO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_FASE_ESTADO").Caption = Value
        End Set
    End Property

    Public Property HeaderNOMBRE_ESTADO_INFORME() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_ESTADO_INFORME").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_ESTADO_INFORME").Caption = Value
        End Set
    End Property

    Public Property HeaderDESCRIPCION_ESTADO() As String
        Get
            Return Me.dxgvLista.Columns("DESCRIPCION_ESTADO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("DESCRIPCION_ESTADO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' <summary>
    ''' Función que Carga la información de los registros de la tabla ESTADO_INFORME_AF
    ''' filtrado por la tabla FASE_ESTADO_INFORME
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorFASE_ESTADO_INFORME(ByVal ID_FASE_ESTADO As Decimal) As Integer
        Me.odsListaPorFASE_ESTADO_INFORME.SelectParameters("ID_FASE_ESTADO").DefaultValue = ID_FASE_ESTADO.ToString()
        Me.odsListaPorFASE_ESTADO_INFORME.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorFASE_ESTADO_INFORME.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorFASE_ESTADO_INFORME.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorFASE_ESTADO_INFORME.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorFASE_ESTADO_INFORME.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorFASE_ESTADO_INFORME"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ESTADO_INFORME")
                keyNames(i) = grid.GetRowValues(i, "ID_FASE_ESTADO")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaESTADO_INFORME_AF
        Dim mLista As New listaESTADO_INFORME_AF
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ESTADO_INFORME")
            Dim lEntidad As New ESTADO_INFORME_AF
            lEntidad.ID_ESTADO_INFORME = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As ESTADO_INFORME_AF = CType(Me.dxgvLista.GetRow(e.VisibleIndex), ESTADO_INFORME_AF)

            If Me.mComponente.EliminarESTADO_INFORME_AF(lEntidad.ID_ESTADO_INFORME) <> 1 Then
