<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleINFORME_FINAL_AF.ascx.vb" Inherits="controles_ucVistaDetalleINFORME_FINAL_AF" %>
<%@ Register assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxEditors" tagprefix="dx" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_INFORME_FINAL">
		<TD width="10"></TD>
		<TD align="right"><dx:ASPxLabel CssClass="Normal" id="lblID_INFORME_FINAL" runat="server" Text="Id informe final:"></dx:ASPxLabel></TD>
		<TD>
			<dx:ASPxTextBox CssClass="TextoLlaveDerecha" id="txtID_INFORME_FINAL" runat="server" ReadOnly="True" Width="70px"></dx:ASPxTextBox></TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trCOMENTARIOS">
		...
		<TD>
			<dx:ASPxTextBox CssClass="TextoNormalIzquierda" id="txtCOMENTARIOS" runat="server" Width="100px" MaxLength="255">
			    <ValidationSettings Display="Dynamic" ErrorText="Valor invalido" SetFocusOnError="True">
			    </ValidationSettings>
			</dx:ASPxTextBox>
</TD>
