...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaAREA_FORMACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla AREA_FORMACION
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderID_AREA_FORMACION() As String
        Get
    ...
    Public Property HeaderAREA_FORMACION() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lAREA_FORMACION As listaAREA_FORMACION
        lAREA_FORMACION = Me.mComponente.ObtenerLista()
        If lAREA_FORMACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lAREA_FORMACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_AREA_FORMACION As Label
            mLabelID_AREA_FORMACION = e.Row.FindControl("Label_ID_AREA_FORMACION")
            mLabelID_AREA_FORMACION.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarAREA_FORMACION(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaAREA_FORMACION
        Dim mLista As New listaAREA_FORMACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_AREA_FORMACION = CInt(CType(mRow.FindControl("Label_ID_AREA_FORMACION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
