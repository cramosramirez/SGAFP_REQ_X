...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP
''' Class	 : ucListaOPCION_MENU
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla OPCION_MENU
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property HeaderOPCION_MENU() As String
        Get
    ...
    Public Property HeaderOPCION_SISTEMA() As String
        Get
    ...
    Public Property HeaderPAGINA_HTML() As String
        Get
    ...
    Public Property HeaderOBJETO_USUARIO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lOPCION_MENU As listaOPCION_MENU
        lOPCION_MENU = Me.mComponente.ObtenerLista()
        If lOPCION_MENU is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lOPCION_MENU
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_OPCION_MENU As Label
            mLabelID_OPCION_MENU = e.Row.FindControl("Label_ID_OPCION_MENU")
            mLabelID_OPCION_MENU.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarOPCION_MENU(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaOPCION_MENU
        Dim mLista As New listaOPCION_MENU
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_OPCION_MENU = CInt(CType(mRow.FindControl("Label_ID_OPCION_MENU"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
