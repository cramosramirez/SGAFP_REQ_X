<%@ Page Title="" Language="VB" MasterPageFile="~/principal.master" AutoEventWireup="false" CodeFile="wfReporteFormatoAsistencia.aspx.vb" Inherits="Reportes_wfReporteFormatoAsistencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="xrListadoAsistencia">
    </dx:ReportViewer>
</asp:Content>
