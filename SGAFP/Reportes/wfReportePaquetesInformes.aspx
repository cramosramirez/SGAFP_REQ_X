<%@ Page Title="" Language="VB" MasterPageFile="~/principalSinUpdatePanel.master" AutoEventWireup="false" CodeFile="wfReportePaquetesInformes.aspx.vb" Inherits="Reportes_wfReportePaqueteInformes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="SGAFP.RL.xrPaquetesInformes">
    </dx:ReportViewer>
</asp:Content>
