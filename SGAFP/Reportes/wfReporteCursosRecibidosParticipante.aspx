<%@ Page Title="" Language="VB" MasterPageFile="~/principal.master" AutoEventWireup="false" CodeFile="wfReporteCursosRecibidosParticipante.aspx.vb" Inherits="Reportes_wfCursosRecibidosParticipante" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:reportviewer id="ReportViewer1" runat="server" reportname="xrCursosRecibidosParticipante">
    </dx:reportviewer>
</asp:Content>
