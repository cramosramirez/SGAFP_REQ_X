<%@ Page Title="" Language="VB" MasterPageFile="~/principalSinUpdatePanel.master" AutoEventWireup="false" CodeFile="wfReporteInformeFinalAnexo2.aspx.vb" Inherits="Reportes_wfReporteInformeFinalAnexo2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="Server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="SGAFP.RL.xrInformeFinalAnexo2">
    </dx:ReportViewer>
</asp:Content>
