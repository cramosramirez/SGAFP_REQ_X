<%@ Page Title="" Language="VB" MasterPageFile="~/principalVacio.master" AutoEventWireup="false" CodeFile="wfReporteFormularioF8.aspx.vb" Inherits="Reportes_wfReporteFormularioF8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" 
        ReportName="SGAFP.RL.xrFormularioF8" >
    </dx:ReportViewer>
</asp:Content>
