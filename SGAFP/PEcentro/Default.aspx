<%@ Page Title="" Language="VB" MasterPageFile="~/principal.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="PEcentro_Default" %>
...
<dx:aspxsitemapcontrol id="ASPxSiteMapControl1" runat="server" datasourceid="ASPxSiteMapDataSource1"
    ...
    <dx:aspxsitemapdatasource id="ASPxSiteMapDataSource1" runat="server" sitemapfilename="~/Web.sitemap"
        startingnodeurl="~/PEcentro/Default.aspx" showstartingnode="True" 
        enableroles="True" />
</asp:Content>
