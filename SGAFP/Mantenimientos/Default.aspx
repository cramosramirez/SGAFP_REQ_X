<%@ Page Title="" Language="VB" MasterPageFile="~/principal.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Mantenimientos_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <dx:aspxsitemapdatasource id="ASPxSiteMapDataSource1" runat="server" sitemapfilename="~/Web.sitemap"
        startingnodeurl="~/Mantenimientos/Default.aspx" showstartingnode="True" 
        enableroles="True" />
</asp:Content>
