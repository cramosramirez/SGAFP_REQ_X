...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_DL
''' Class	 : DL.dbASISTENCIA_AF
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ASISTENCIA_AF
''' </summary>
''' <remarks>
...
#Region " Metodos Generador "
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function ObtenerListaPorID(Optional ByVal asColumnaOrden As String = "", Optional ByVal asTipoOrden As String = "ASC") As listaASISTENCIA_AF
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet, Optional ByVal asColumnaOrden As String = "", Optional ByVal asTipoOrden As String = "ASC") As Integer
        ...
        tables(0) = New String("ASISTENCIA_AF".ToCharArray())
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.AppendLine(" SELECT ASISTENCIA_AF.ID_ASISTENCIA_AF, ")
        strSQL.AppendLine(" ASISTENCIA_AF.ID_ACCION_FORMATIVA, ")
        strSQL.AppendLine(" ASISTENCIA_AF.FECHA, ")
        strSQL.AppendLine(" ASISTENCIA_AF.INSTRUCTOR, ")
        strSQL.AppendLine(" ASISTENCIA_AF.NOTAS, ")
        strSQL.AppendLine(" ASISTENCIA_AF.USERID, ")
        strSQL.AppendLine(" ASISTENCIA_AF.LASTUPDATE, ")
        strSQL.AppendLine(" ASISTENCIA_AF.CANTIDAD_HORAS ")
        strSQL.AppendLine(" FROM ASISTENCIA_AF ")
...
#Region "Obtener Listas Por Foraneas"
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function ObtenerListaPorACCION_FORMATIVA(ByVal ID_ACCION_FORMATIVA As Decimal, Optional ByVal asColumnaOrden As String = "", Optional ByVal asTipoOrden As String = "ASC") As listaASISTENCIA_AF
