...
Public Class frmAnalisisCaracSocialesPATI

    Private nombreArchivo As String = "AnalisisCaracSociales"
    ...
    Private Sub frmAnalisisCaracSocialesPATI_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.CargarDatos()
    End Sub
    ...
    Private Sub InicializarVariables()
        Me.CbxPROGRAMA_FORMACION1.Recuperar()
        Me.SpinEdit1.Value = 0
        Me.dteFechaInicial.Value = New DateTime(1900, 1, 1, 0, 0, 0)
        Me.dteFechaFinal.Value = New DateTime(1900, 1, 1, 0, 0, 0)
    End Sub
    ...
    Public Sub RecuperarDatos()
        ...
        If Me.CbxPROGRAMA_FORMACION1.SelectedValue IsNot Nothing Then
            If Utilerias.EsProgramaPATI(CInt(Me.CbxPROGRAMA_FORMACION1.SelectedValue)) Then
                ...
                If lIdFuente = -1 And lNoConvocatoria = -1 Then
                    Me.PatiAnalisisCaractSocialesTableAdapter1.Fill(DS_DL1.PATIAnalisisCaractSociales)
                Else
                    Me.PatiAnalisisCaractSocialesTableAdapter1.FillPorFuenteConvocatoria(DS_DL1.PATIAnalisisCaractSociales, lIdFuente, lNoConvocatoria)
                End If
            Else
                If Me.txtNUM_LICITACION.EditValue = "_/____" AndAlso Me.dteFechaInicial.Value = New DateTime(1900, 1, 1, 0, 0, 0) AndAlso Me.dteFechaFinal.Value = New DateTime(1900, 1, 1, 0, 0, 0) Then
                    MsgBox("Ingrese Licitación o Periodo")
                    Return
                End If
                If Me.txtNUM_LICITACION.EditValue <> "_/____" AndAlso (Me.dteFechaInicial.Value <> New DateTime(1900, 1, 1, 0, 0, 0) OrElse Me.dteFechaFinal.Value <> New DateTime(1900, 1, 1, 0, 0, 0)) Then
                    MsgBox("La búsqueda únicamente se realiza por Licitación o período")
                    Return
                End If
                DS_DL1.Clear()
                If Me.txtNUM_LICITACION.EditValue <> "_/____" Then
                    Me.PatiAnalisisCaractSocialesTableAdapter1.FillPorLicitacion(DS_DL1.PATIAnalisisCaractSociales, Me.txtNUM_LICITACION.Text)
                Else
                    Me.PatiAnalisisCaractSocialesTableAdapter1.FillPorProgramaPeriodoEjecucion(DS_DL1.PATIAnalisisCaractSociales, CbxPROGRAMA_FORMACION1.SelectedValue, Me.dteFechaInicial.Value.Date, Me.dteFechaFinal.Value.Date)
                End If
            End If
        End If
    ...
    Private Sub CbxPROGRAMA_FORMACION1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles CbxPROGRAMA_FORMACION1.SelectedIndexChanged
        If CbxPROGRAMA_FORMACION1.SelectedValue IsNot Nothing Then
            Select Case CbxPROGRAMA_FORMACION1.SelectedValue
                Case Enumeradores.ProgramasFormacion.HABIL_TECNICO_PERMANENTE, Enumeradores.ProgramasFormacion.PROYECTO_ESPECIAL
                    Me.lytLicitacion.Visibility = IIf(CbxPROGRAMA_FORMACION1.SelectedValue = Enumeradores.ProgramasFormacion.HABIL_TECNICO_PERMANENTE, DevExpress.XtraLayout.Utils.LayoutVisibility.Always, DevExpress.XtraLayout.Utils.LayoutVisibility.Never)
                    Me.lytConvocatoria.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                    Me.lytFechaInicial.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
                    Me.lytFechaFinal.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
                    Me.dteFechaInicial.Text = ""
                    Me.dteFechaFinal.Text = ""

                Case Else 'PATI
                    Me.lytLicitacion.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                    Me.lytConvocatoria.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
                    Me.lytFechaInicial.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                    Me.lytFechaFinal.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
            End Select
            Me.txtTituloGrafico.Text = "Participantes " + (New cPROGRAMA_FORMACION).ObtenerPROGRAMA_FORMACION(CDec(CbxPROGRAMA_FORMACION1.SelectedValue)).NOMBRE_PROGRAMA_FORMACION
        End If
    End Sub
End Class
