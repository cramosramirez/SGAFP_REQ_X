...
''' </history>
''' -----------------------------------------------------------------------------
Public Class ucDetalleMUNICIPIO
    ...
    Public Overrides Property DataSource() As System.Windows.Forms.BindingSource 
        Get 
            Return Me.ListaMUNICIPIOBindingSource 
        End Get 
        Set(ByVal value As System.Windows.Forms.BindingSource) 
            Me.ListaMUNICIPIOBindingSource = value 
        End Set 
    End Property 

    Private Sub ListaMUNICIPIOBindingSource_CurrentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListaMUNICIPIOBindingSource.CurrentChanged
    ...
    Public Overrides Function Actualizar() As Integer 
        ...
        mEntidad = Me.Current 
        Dim mControl As New cMUNICIPIO 
    	   If mControl.ActualizarMUNICIPIO(mEntidad) < 1 Then 
            Me.AsignarMensaje("No se pudo guardar el registro", True) 
            Return -1 
        End If 
        Me.CODIGO_MUNICIPIOTextBox.Text = mEntidad.CODIGO_MUNICIPIO.ToString()
        Return 1 
    End Function 
    ''' -----------------------------------------------------------------------------
    ''' <summary>
