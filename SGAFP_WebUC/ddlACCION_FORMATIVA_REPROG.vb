...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_WebUC
''' Class	 : WebUC.ddlACCION_FORMATIVA_REPROG
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ACCION_FORMATIVA_REPROG"), ToolboxData("<{0}:ddlACCION_FORMATIVA_REPROG runat=server></{0}:ddlACCION_FORMATIVA_REPROG>")> _
Public Class ddlACCION_FORMATIVA_REPROG
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla ACCION_FORMATIVA_REPROG.
    ''' </summary>
    ''' <remarks>
