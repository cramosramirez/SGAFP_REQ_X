...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_EVALUACION_AF"), ToolboxData("<{0}:lbEVALUACION_AF runat=server></{0}:lbEVALUACION_AF>")> _
Public Class lbEVALUACION_AF
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla EVALUACION_AF.
    ''' </summary>
    ''' <remarks>
