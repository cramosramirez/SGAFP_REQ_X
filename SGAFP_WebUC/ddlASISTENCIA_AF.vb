...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ASISTENCIA_AF"), ToolboxData("<{0}:ddlASISTENCIA_AF runat=server></{0}:ddlASISTENCIA_AF>")> _
Public Class ddlASISTENCIA_AF
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla ASISTENCIA_AF.
    ''' </summary>
    ''' <remarks>
