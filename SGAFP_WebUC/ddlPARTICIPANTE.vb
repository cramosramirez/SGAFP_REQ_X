...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PARTICIPANTE"), ToolboxData("<{0}:ddlPARTICIPANTE runat=server></{0}:ddlPARTICIPANTE>")> _
Public Class ddlPARTICIPANTE
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla PARTICIPANTE.
    ''' </summary>
    ''' <remarks>
