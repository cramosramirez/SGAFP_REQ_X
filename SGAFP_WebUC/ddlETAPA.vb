...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("CODIGO_ETAPA"), ToolboxData("<{0}:ddlETAPA runat=server></{0}:ddlETAPA>")> _
Public Class ddlETAPA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla ETAPA.
    ''' </summary>
