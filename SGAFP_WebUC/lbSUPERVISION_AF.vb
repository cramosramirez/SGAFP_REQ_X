...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_SUPERVISION_AF"), ToolboxData("<{0}:lbSUPERVISION_AF runat=server></{0}:lbSUPERVISION_AF>")> _
Public Class lbSUPERVISION_AF
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla SUPERVISION_AF.
    ''' </summary>
    ''' <remarks>
