...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_GRUPO_SOLICITUD"), ToolboxData("<{0}:lbGRUPO_SOLICITUD runat=server></{0}:lbGRUPO_SOLICITUD>")> _
Public Class lbGRUPO_SOLICITUD
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla GRUPO_SOLICITUD.
    ''' </summary>
    ''' <remarks>
