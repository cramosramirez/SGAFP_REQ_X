...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_OPCION_GRUPO"), ToolboxData("<{0}:ddlOPCION_GRUPO runat=server></{0}:ddlOPCION_GRUPO>")> _
Public Class ddlOPCION_GRUPO
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla OPCION_GRUPO.
    ''' </summary>
    ''' <remarks>
