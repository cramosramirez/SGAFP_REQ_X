...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_DESEMBOLSO"), ToolboxData("<{0}:lbDESEMBOLSO runat=server></{0}:lbDESEMBOLSO>")> _
Public Class lbDESEMBOLSO
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla DESEMBOLSO.
    ''' </summary>
    ''' <remarks>
