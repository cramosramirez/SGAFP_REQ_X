...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_WebUC
''' Class	 : WebUC.ddlFACILITADOR_CAPACITADOR
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_FACILITADOR"), ToolboxData("<{0}:ddlFACILITADOR_CAPACITADOR runat=server></{0}:ddlFACILITADOR_CAPACITADOR>")> _
Public Class ddlFACILITADOR_CAPACITADOR
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla FACILITADOR_CAPACITADOR.
    ''' </summary>
    ''' <remarks>
