...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PROVEEDOR_AF"), ToolboxData("<{0}:lbPROVEEDOR_AF runat=server></{0}:lbPROVEEDOR_AF>")> _
Public Class lbPROVEEDOR_AF
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla PROVEEDOR_AF.
    ''' </summary>
    ''' <remarks>
