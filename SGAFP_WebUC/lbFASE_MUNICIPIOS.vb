...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_FASE_MUNICIPIO"), ToolboxData("<{0}:lbFASE_MUNICIPIOS runat=server></{0}:lbFASE_MUNICIPIOS>")> _
Public Class lbFASE_MUNICIPIOS
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla FASE_MUNICIPIOS.
    ''' </summary>
    ''' <remarks>
