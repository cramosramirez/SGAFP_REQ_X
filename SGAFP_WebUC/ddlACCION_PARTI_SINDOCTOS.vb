...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_WebUC
''' Class	 : WebUC.ddlACCION_PARTI_SINDOCTOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ACCION_PARTI"), ToolboxData("<{0}:ddlACCION_PARTI_SINDOCTOS runat=server></{0}:ddlACCION_PARTI_SINDOCTOS>")> _
Public Class ddlACCION_PARTI_SINDOCTOS
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla ACCION_PARTI_SINDOCTOS.
    ''' </summary>
    ''' <remarks>
