...
''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_WebUC
''' Class	 : WebUC.ddlPARTICIPANTE_EXONERADO_DOC
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PARTICIPANTE_EXONERADO"), ToolboxData("<{0}:ddlPARTICIPANTE_EXONERADO_DOC runat=server></{0}:ddlPARTICIPANTE_EXONERADO_DOC>")> _
Public Class ddlPARTICIPANTE_EXONERADO_DOC
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla PARTICIPANTE_EXONERADO_DOC.
    ''' </summary>
    ''' <remarks>
