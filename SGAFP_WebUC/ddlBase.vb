...
Public Class ddlBase
    ...
    Public Sub AgregarVacioNumerico()
        Me.Items.Add(New ListItem("[Vacio]", "-1"))
    End Sub

    Public Sub AgregarVacioCadena()
        Me.Items.Add(New ListItem("[Vacio]", ""))
    End Sub

    Public Sub AgregarTodosNumerico()
        Me.Items.Add(New ListItem("[Todos]", "-1"))
    End Sub

    Public Sub AgregarTodosCadena()
        Me.Items.Add(New ListItem("[Todos]", ""))
    End Sub
