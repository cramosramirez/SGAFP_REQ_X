<Serializable(), Table(Name:="PARTICIPANTE_AF_REPETIDOS")> Public Class PARTICIPANTE_AF_REPETIDOS
    Inherits entidadBase
    Implements IEquatable(Of PARTICIPANTE_AF_REPETIDOS), IComparable(Of PARTICIPANTE_AF_REPETIDOS)
...
#Region " Metodos Generador "
    ...
    Public Sub New(ByVal aID_PARTICIPANTE As Decimal, ByVal aID_ACCION_FORMATIVA As Decimal, ByVal aID_SOLICITUD As Decimal, ByVal aESTADO As String, ByVal aFECHA_INSCRIPCION As DateTime, ByVal aNOTA_FINAL As Decimal, ByVal aPORC_ASISTENCIA As Decimal, ByVal aENTREGA_DIPLOMA As String, ByVal aNOTAS As String)
    ...
    Public Function Equals1(ByVal other As PARTICIPANTE_AF_REPETIDOS) As Boolean Implements System.IEquatable(Of PARTICIPANTE_AF_REPETIDOS).Equals
        Return Me.ID_PARTICIPANTE = other.ID_PARTICIPANTE And Me.ID_ACCION_FORMATIVA = other.ID_ACCION_FORMATIVA
    End Function

    Public Function CompareTo(ByVal other As PARTICIPANTE_AF_REPETIDOS) As Integer Implements System.IComparable(Of PARTICIPANTE_AF_REPETIDOS).CompareTo
