''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_EL
''' Class	 : EL.PARTICIPANTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row PARTICIPANTE en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="PARTICIPANTE")> Public Class PARTICIPANTE
    Inherits entidadBase
    Implements IEquatable(Of PARTICIPANTE), IComparable(Of PARTICIPANTE)
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_PARTICIPANTE As Decimal, aNOMBRES As String, aAPELLIDOS As String, aGENERO As String, aID_PAIS As Decimal, aFECHA_NACIMIENTO As DateTime, aDIRECCION As String, aDUI As String, aNIT As String, aISSS As String, aTIPO_DOCTO As Decimal, aNUM_DOCTO As String, aTELEFONO As String, aMOVIL As String, aEMAIL As String, aID_ESTADO_CIVIL As Decimal, aPROFESION_OFICIO As String, aOCUPACION_ACTUAL As String, aTITULO_CERTIFICADO_OBTENIDO As String, aDEPARTAMENTO_NAC As String, aMUNICIPIO_NAC As String, aCODIGO_DEPARTAMENTO As String, aCODIGO_MUNICIPIO As String, aID_NIVEL_ACADEMICO As Decimal, aOTRA_EDUCACION_FORMAL As String, aCON_DISCAPACIDAD As Decimal, aDISC_OTRA As String, aLASTUPDATE As DateTime, aUSERID As String)
    ...
    Public Function Equals1(ByVal other As PARTICIPANTE) As Boolean Implements System.IEquatable(Of PARTICIPANTE).Equals
        Return Me.ID_PARTICIPANTE = other.ID_PARTICIPANTE
    End Function

    Public Function CompareTo(ByVal other As PARTICIPANTE) As Integer Implements System.IComparable(Of PARTICIPANTE).CompareTo
...
#Region " Relaciones "
    Private _PARTICIPANTE_AFPARTICIPANTE As ListaPARTICIPANTE_AF
    Public Property PARTICIPANTE_AFPARTICIPANTE() As ListaPARTICIPANTE_AF
        Get
            Return _PARTICIPANTE_AFPARTICIPANTE
        End Get
        Set(ByVal Value As ListaPARTICIPANTE_AF)
            _PARTICIPANTE_AFPARTICIPANTE = Value
        End Set
    End Property 

    Private _DISCA_POR_PARTICIPANTEPARTICIPANTE As ListaDISCA_POR_PARTICIPANTE
    Public Property DISCA_POR_PARTICIPANTEPARTICIPANTE() As ListaDISCA_POR_PARTICIPANTE
        Get
            Return _DISCA_POR_PARTICIPANTEPARTICIPANTE
        End Get
        Set(ByVal Value As ListaDISCA_POR_PARTICIPANTE)
            _DISCA_POR_PARTICIPANTEPARTICIPANTE = Value
        End Set
    End Property 
