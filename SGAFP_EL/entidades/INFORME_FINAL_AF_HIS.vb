''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_EL
''' Class	 : EL.INFORME_FINAL_AF_HIS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row INFORME_FINAL_AF_HIS en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="INFORME_FINAL_AF_HIS")> Public Class INFORME_FINAL_AF_HIS
    Inherits entidadBase
    Implements IEquatable(Of INFORME_FINAL_AF_HIS), IComparable(Of INFORME_FINAL_AF_HIS)
...
#Region " Metodos Generador "
    ...
    Public Sub New(ByVal aID_INFORME_FINAL_HIS As Decimal, ByVal aID_INFORME_FINAL As Decimal, ByVal aID_ACCION_FORMATIVA As Decimal, ByVal aID_PROVEEDOR_AF As Decimal, ByVal aFECHA_INFORME As DateTime, ByVal aNUMERO_FACTURA As String, ByVal aELABORADO_POR As String, ByVal aMONTO_FACTURA As Decimal, ByVal aMONTO_APROBADO As Decimal, ByVal aPARTICIPANTES_INSCRITOS As Decimal, ByVal aPARTICIPANTES_FINALES As Decimal, ByVal aPORC_PROM_ASISTENCIA As Decimal, ByVal aNOTA_PROMEDIO As Decimal, ByVal aESTADO As String, ByVal aCOMENTARIOS As String, ByVal aUSUARIO_APROBACION As String, ByVal aLASTUPDATE As DateTime, ByVal aUSERID As String, ByVal aID_ESTADO_INFORME As Decimal, ByVal aHORAS_DESARROLLADAS As Decimal, ByVal aFECHA_INICIAL As DateTime, ByVal aFECHA_FINAL As DateTime, ByVal aHORARIO As String, ByVal aCOSTO_X_HORA As Decimal)
        Me._ID_INFORME_FINAL_HIS = aID_INFORME_FINAL_HIS
    ...
    Public Function Equals1(ByVal other As INFORME_FINAL_AF_HIS) As Boolean Implements System.IEquatable(Of INFORME_FINAL_AF_HIS).Equals
        Return Me.ID_INFORME_FINAL_HIS = other.ID_INFORME_FINAL_HIS
    End Function

    Public Function CompareTo(ByVal other As INFORME_FINAL_AF_HIS) As Integer Implements System.IComparable(Of INFORME_FINAL_AF_HIS).CompareTo
        If Me.ID_INFORME_FINAL_HIS > other.ID_INFORME_FINAL_HIS Then Return 1
        If Me.ID_INFORME_FINAL_HIS < other.ID_INFORME_FINAL_HIS Then Return -1
        Return 0
    End Function
...
#Region " Properties "
    ...
    <Column(Name:="Id informe final his", Storage:="ID_INFORME_FINAL_HIS", DbType:="NUMBER NOT NULL", Id:=True), _
     DataObjectField(True, False, False), Precision(Precision:=8, Scale:=0)> _
    Public Property ID_INFORME_FINAL_HIS() As Decimal
        Get
            Return _ID_INFORME_FINAL_HIS
        End Get
        Set(ByVal Value As Decimal)
            _ID_INFORME_FINAL_HIS = Value
            OnPropertyChanged("ID_INFORME_FINAL_HIS")
        End Set
    End Property 
    ...
    <Column(Name:="Fecha informe", Storage:="FECHA_INFORME", DbType:="DATE NOT NULL", Id:=False), _
    ...
    <Column(Name:="Monto factura", Storage:="MONTO_FACTURA", DbType:="NUMBER NOT NULL", Id:=False), _
     DataObjectField(False, False, False), Precision(Precision:=12, Scale:=2)> _
    ...
    <Column(Name:="Costo hora", Storage:="COSTO_X_HORA", DbType:="NUMBER NOT NULL", Id:=False), _
    ...
    <Column(Name:="Monto aprobado", Storage:="MONTO_APROBADO", DbType:="NUMBER NOT NULL", Id:=False), _
     DataObjectField(False, False, False), Precision(Precision:=12, Scale:=2)> _
    ...
    <Column(Name:="Participantes inscritos", Storage:="PARTICIPANTES_INSCRITOS", DbType:="NUMBER NOT NULL", Id:=False), _
    ...
    <Column(Name:="Participantes finales", Storage:="PARTICIPANTES_FINALES", DbType:="NUMBER NOT NULL", Id:=False), _
     DataObjectField(False, False, False), Precision(Precision:=0, Scale:=0)> _
    ...
    <Column(Name:="Porc prom asistencia", Storage:="PORC_PROM_ASISTENCIA", DbType:="NUMBER NOT NULL", Id:=False), _
