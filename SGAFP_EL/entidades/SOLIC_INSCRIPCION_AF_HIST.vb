''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_EL
''' Class	 : EL.SOLIC_INSCRIPCION_AF_HIST
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row SOLIC_INSCRIPCION_AF_HIST en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="SOLIC_INSCRIPCION_AF_HIST")> Public Class SOLIC_INSCRIPCION_AF_HIST
    Inherits entidadBase
    Implements IEquatable(Of SOLIC_INSCRIPCION_AF_HIST), IComparable(Of SOLIC_INSCRIPCION_AF_HIST)
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_SOLICITUD_HIST As Decimal, aID_SOLICITUD As Decimal, aFECHA_PRESENTACION As DateTime, aID_PARTICIPANTE As Decimal, aID_ACCION_FORMATIVA As Decimal, aID_ESTADO_SOLICITUD As Decimal, aNOMBRES As String, aAPELLIDOS As String, aDUI As String, aTIPO_DOCTO As Decimal, aNUM_DOCTO As String, aNIT As String, aISSS As String, aID_TIPO_SOLICITUD As Decimal, aID_PAIS As Decimal, aDEPARTAMENTO_NAC As String, aMUNICIPIO_NAC As String, aFECHA_NACIMIENTO As DateTime, aGENERO As String, aEDAD As Decimal, aMIEMBROS_GRUPO_FAMILIAR As Decimal, aID_ESTADO_CIVIL As Decimal, aES_JEFE_HOGAR As Decimal, aTIENE_HIJOS As Decimal, aNO_DE_HIJOS As Decimal, aSE_DEDICA_ALGUNA_PROFESION As Decimal, aPROFESION_OFICIO As String, aDIRECCION As String, aCODIGO_DEPARTAMENTO As String, aCODIGO_MUNICIPIO As String, aTELEFONO As String, aMOVIL As String, aEMAIL As String, aCON_DISCAPACIDAD As Decimal, aDISC_OTRA As String, aID_LEE_ESCRIBE As Decimal, aID_NIVEL_ACADEMICO As Decimal, aOTRA_EDUCACION_FORMAL As String, aTITULO_CERTIFICADO_OBTENIDO As String, aESTUDIA_ACTUALMENTE As Decimal, aID_TIEMPO_DEJO_ESTUDIAR As Decimal, aRECIBIO_CURSO_ANTERIOR As String, aBENEF_PROM_EMP_ACT As Decimal, aBENEF_OBT_EMPLEO As Decimal, aBENEF_OBT_ING_EXTRA As Decimal, aBENEF_CAMB_EMP_X_CURSO As Decimal, aBENEF_TRAB_CTA_PROPIA As Decimal, aBENEF_OTRO As String, aRAZON_NO_BENEFICIO As String, aOCUACT_TRABAJA As Decimal, aOCUACT_ESTUDIA As Decimal, aOCUACT_DESOCUPADO As Decimal, aOCUACT_OFICIO_HOGAR As Decimal, aOCUACT_BUSCA_TRABAJO As Decimal, aOCUACT_OTRA As String, aID_TIPO_EMPLEO As Decimal, aSECTOR_EMPLEO As Decimal, aTRABAJO_ANTERIOR As String, aRECIBE_INGRESOS As Decimal, aMANERA_OBT_ING_TRABAJO As Decimal, aMANERA_OBT_ING_AYUDA_FAM As Decimal, aMANERA_OBT_ING_REMESA As Decimal, aMANERA_OBT_ING_PENSION As Decimal, aMANERA_OBT_ING_OTRO As String, aEXPFOR_PROMOCION_EMPLEO As Decimal, aEXPFOR_CAMBIAR_EMPLEO As Decimal, aEXPFOR_OBTENER_EMPLEO As Decimal, aEXPFOR_TRABAJAR_CTA_PROPIA As Decimal, aEXPFOR_INGRESOS_EXTRAS As Decimal, aEXPFOR_NINGUNO As Decimal, aEXPFOR_OTRO As String, aCURSO_REL_TRAB_ACTUAL As Decimal, aCURSO_REL_TRAB_NUEVO As Decimal, aNOMBRE_REFERENCIA As String, aID_REFERENCIA As Decimal, aDIRECCION_REFERENCIA As String, aDEPARTAMENTO_REFERENCIA As String, aMUNICIPIO_REFERENCIA As String, aTELEFONO_REFERENCIA As String, aMOVIL_REFERENCIA As String, aEMAIL_REFERENCIA As String, aSUGERENCIAS As String, aUSERID As String, aLASTUPDATE As DateTime)
    ...
    Public Function Equals1(ByVal other As SOLIC_INSCRIPCION_AF_HIST) As Boolean Implements System.IEquatable(Of SOLIC_INSCRIPCION_AF_HIST).Equals
        Return Me.ID_SOLICITUD_HIST = other.ID_SOLICITUD_HIST
    End Function

    Public Function CompareTo(ByVal other As SOLIC_INSCRIPCION_AF_HIST) As Integer Implements System.IComparable(Of SOLIC_INSCRIPCION_AF_HIST).CompareTo
...
#Region " Properties "
    ...
    Private _fkID_TIPO_EMPLEO As TIPO_EMPLEO
    Public Property fkID_TIPO_EMPLEO() As TIPO_EMPLEO
        Get
            Return _fkID_TIPO_EMPLEO
        End Get
        Set(ByVal Value As TIPO_EMPLEO)
            _fkID_TIPO_EMPLEO = Value
        End Set
    End Property 
    ...
    <Column(Name:="Telefono referencia", Storage:="TELEFONO_REFERENCIA", DbType:="CHAR(8)", Id:=False), _
    ...
    <Column(Name:="Movil referencia", Storage:="MOVIL_REFERENCIA", DbType:="CHAR(8)", Id:=False), _
     DataObjectField(False, False, True, 8)> _
