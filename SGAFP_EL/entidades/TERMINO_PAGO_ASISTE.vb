''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_EL
''' Class	 : EL.TERMINO_PAGO_ASISTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row TERMINO_PAGO_ASISTE en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="TERMINO_PAGO_ASISTE")> Public Class TERMINO_PAGO_ASISTE
    Inherits entidadBase
    Implements IEquatable(Of TERMINO_PAGO_ASISTE), IComparable(Of TERMINO_PAGO_ASISTE)
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_TERMINO_ASISTE As Decimal, aID_TERMINO_PARAM As Decimal, aID_MODALIDAD_FORMACION As Decimal, aPORC_ASISTE_INI As Decimal, aPORC_ASISTE_FIN As Decimal, aPORC_PAGO_COSTO_PARTI As Decimal, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime)
        Me._ID_TERMINO_ASISTE = aID_TERMINO_ASISTE
    ...
    Public Function Equals1(ByVal other As TERMINO_PAGO_ASISTE) As Boolean Implements System.IEquatable(Of TERMINO_PAGO_ASISTE).Equals
        Return Me.ID_TERMINO_ASISTE = other.ID_TERMINO_ASISTE
    End Function

    Public Function CompareTo(ByVal other As TERMINO_PAGO_ASISTE) As Integer Implements System.IComparable(Of TERMINO_PAGO_ASISTE).CompareTo
        If Me.ID_TERMINO_ASISTE > other.ID_TERMINO_ASISTE Then Return 1
        If Me.ID_TERMINO_ASISTE < other.ID_TERMINO_ASISTE Then Return -1
        Return 0
    End Function
...
#Region " Properties "
    ...
    Private _ID_TERMINO_ASISTE As Decimal
    <Column(Name:="Id termino asiste", Storage:="ID_TERMINO_ASISTE", DbType:="NUMBER NOT NULL", Id:=True), _
     DataObjectField(True, False, False), Precision(Precision:=0, Scale:=0)> _
    Public Property ID_TERMINO_ASISTE() As Decimal
        Get
            Return _ID_TERMINO_ASISTE
        End Get
        Set(ByVal Value As Decimal)
            _ID_TERMINO_ASISTE = Value
            OnPropertyChanged("ID_TERMINO_ASISTE")
        End Set
    End Property 
