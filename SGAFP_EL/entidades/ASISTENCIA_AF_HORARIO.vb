''' -----------------------------------------------------------------------------
''' Project	 : SGAFP_EL
''' Class	 : EL.ASISTENCIA_AF_HORARIO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ASISTENCIA_AF_HORARIO en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="ASISTENCIA_AF_HORARIO")> Public Class ASISTENCIA_AF_HORARIO
    Inherits entidadBase
    Implements IEquatable(Of ASISTENCIA_AF_HORARIO), IComparable(Of ASISTENCIA_AF_HORARIO)
...
#Region " Metodos Generador "
    ...
    Public Function Equals1(ByVal other As ASISTENCIA_AF_HORARIO) As Boolean Implements System.IEquatable(Of ASISTENCIA_AF_HORARIO).Equals
        Return Me.ID_ASISTENCIA_AF = other.ID_ASISTENCIA_AF And Me.ID_ASISTENCIA_AF_HORARIO = other.ID_ASISTENCIA_AF_HORARIO
    End Function

    Public Function CompareTo(ByVal other As ASISTENCIA_AF_HORARIO) As Integer Implements System.IComparable(Of ASISTENCIA_AF_HORARIO).CompareTo
...
#Region " Propiedades "
    ...
    <Column(Name:="Hora inicio", Storage:="HORA_INICIO", DbType:="DATE", Id:=False), _
    ...
    <Column(Name:="Cantidad minutos", Storage:="CANTIDAD_MINUTOS", DbType:="NUMBER", Id:=False), _
