    ...
    Private Sub BuscarToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BuscarToolStripButton.Click
        If _tipoAccion = TipoAccion.Busqueda Then
            ...
            Else
                ...
                Dim lProdDes As PropertyDescriptor = Nothing
                For Each prop As PropertyDescriptor In props
                    If prop.Name = Me.CriteriaList(0).ColumnName Then
                        lProdDes = prop
                        Exit For
                    End If
                Next
                If lProdDes Is Nothing Then Return
                index = CType(listaDatos, IBindingListView).Find(lProdDes, Me.CriteriaList(0).DataValue)
                If index = -1 Then
        ...
        ElseIf _tipoAccion = TipoAccion.Consulta Then
            Dim listaResultante As IBindingListView
